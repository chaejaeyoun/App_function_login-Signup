// This file was generated based on /usr/local/share/uno/Packages/Fuse.Controls.ScrollView/1.10.0-rc1/Scroller.uno.
...
struct Scroller_type : ::g::Fuse::Node_type
{
    ...
    ::g::Fuse::Input::IGesture interface8;
};
...
struct Scroller : ::g::Fuse::Behavior
{
    ...
    void MoveUser(int32_t flags, double time);
