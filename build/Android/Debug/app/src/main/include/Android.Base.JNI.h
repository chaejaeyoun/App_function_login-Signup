// This file was generated based on /usr/local/share/uno/Packages/UnoCore/1.10.0-rc1/Targets/Android/Uno/Base/JNI.uno.
...
struct JNI : uObject
{
    ...
    static int32_t GetArrayLength(jobject array_);
    ...
    static int32_t GetRefType(JNIEnv* jni, jobject obj);
    static int32_t GetRefType1(jobject obj);
    ...
    static void SetBooleanArrayRegion(jobject javaArr, uArray* unoArr, int32_t start, int32_t len);
    static void SetByteArrayRegion(jobject javaArr, uArray* unoArr, int32_t start, int32_t len);
    static void SetByteArrayRegion1(jobject javaArr, uArray* unoArr, int32_t start, int32_t len);
    static void SetCharArrayRegion(jobject javaArr, uArray* unoArr, int32_t start, int32_t len);
    static void SetDoubleArrayRegion(jobject javaArr, uArray* unoArr, int32_t start, int32_t len);
    static void SetFloatArrayRegion(jobject javaArr, uArray* unoArr, int32_t start, int32_t len);
    static void SetIntArrayRegion(jobject javaArr, uArray* unoArr, int32_t start, int32_t len);
    static void SetLongArrayRegion(jobject javaArr, uArray* unoArr, int32_t start, int32_t len);
    static void SetShortArrayRegion(jobject javaArr, uArray* unoArr, int32_t start, int32_t len);
