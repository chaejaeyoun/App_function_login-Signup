// This file was generated based on /usr/local/share/uno/Packages/Fuse.Motion/1.10.0-rc1/Simulation/SmoothSnap.uno.
...
struct SmoothSnap : uObject
{
    ...
    static SmoothSnap* CreateUnit(uType* __type, int32_t unit);
