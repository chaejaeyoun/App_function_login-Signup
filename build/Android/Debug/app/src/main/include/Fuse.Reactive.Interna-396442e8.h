// This file was generated based on /usr/local/share/uno/Packages/Fuse.Reactive.Bindings/1.10.0-rc1/Internal/PatchList.uno.
...
struct SimpleAlgorithm : uObject
{
    ...
    void AppendRemainingTo(int32_t oPos);
    ::g::Uno::Collections::List* Calc();
    SimpleAlgorithm__Location FindNextAnchor(int32_t fromAt);
