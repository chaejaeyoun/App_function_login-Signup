// This file was generated based on /usr/local/share/uno/Packages/Fuse.Controls.Native/1.10.0-rc1/NativeRenderer.uno.
...
struct NativeViewRenderer : uObject
{
    ...
    static ::g::Java::Object* AllocPixelBuffer(int32_t w, int32_t h);
    static void FreePixelBuffer(::g::Java::Object* bitmap);
    static NativeViewRenderer* New1();
    static void Upload(::g::Java::Object* viewHandle, ::g::Java::Object* pixelBuffer, bool reuse, int32_t w, int32_t h);
};
// }
