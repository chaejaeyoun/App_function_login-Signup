// This file was generated based on /usr/local/share/uno/Packages/Fuse.Scripting/1.10.0-rc1/ScriptModule.Evaluate.uno.
...
namespace g{namespace Fuse{namespace Scripting{struct Dependency;}}}
...
{
    void(*fp_CallModuleFunc)(::g::Fuse::Scripting::ScriptModule*, ::g::Fuse::Scripting::Context*, ::g::Fuse::Scripting::Function*, uArray*);
...
struct ScriptModule : ::g::Fuse::Scripting::Module
{
    ...
    void CallModuleFunc(::g::Fuse::Scripting::Context* context, ::g::Fuse::Scripting::Function* moduleFunc, uArray* args) { (((ScriptModule_type*)__type)->fp_CallModuleFunc)(this, context, moduleFunc, args); }
    uString* Code();
    ...
    int32_t GetPreambleNewlines();
    uString* GetSourcePath();
    int32_t LineNumberOffset();
    void LineNumberOffset(int32_t value);
    ...
    static void CallModuleFunc(ScriptModule* __this, ::g::Fuse::Scripting::Context* context, ::g::Fuse::Scripting::Function* moduleFunc, uArray* args) { ScriptModule__CallModuleFunc_fn(__this, context, moduleFunc, args); }
