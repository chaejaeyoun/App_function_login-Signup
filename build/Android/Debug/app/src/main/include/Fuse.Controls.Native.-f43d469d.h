// This file was generated based on /usr/local/share/uno/Packages/Fuse.Controls.Native/1.10.0-rc1/Android/InputDispatch.uno.
...
struct InputDispatch : uObject
{
    ...
    static void DeactivatePointer(int32_t pointerId);
    static ::g::Fuse::Visual* FindRoot(::g::Fuse::Visual* visual);
    static bool IsPointerActive(int32_t pointerId);
