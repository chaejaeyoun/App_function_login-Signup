...
namespace g{struct App_LoginSignup_FuseTriggersActionsDebugAction_Message_Property;}
...
struct App_LoginSignup_FuseTriggersActionsDebugAction_Message_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::Fuse::Triggers::Actions::DebugAction*> _obj;

    void ctor_3(::g::Fuse::Triggers::Actions::DebugAction* obj, ::g::Uno::UX::Selector name);
    static App_LoginSignup_FuseTriggersActionsDebugAction_Message_Property* New1(::g::Fuse::Triggers::Actions::DebugAction* obj, ::g::Uno::UX::Selector name);
};
// }
