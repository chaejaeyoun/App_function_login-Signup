// This file was generated based on /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.10.0-rc1/V8/V8SimpleExtensions.uno.
...
struct V8SimpleExtensions : uObject
{
    ...
    static int32_t AsInt(::JSValue* value);
    ...
    static ::JSValue* CilCallbackImpl(::JSContext* context, void* data, uArray* args, int32_t numArgs, ::JSValue** error);
    ...
    static int32_t GetJSType(::JSValue* value);
    static int32_t GetLineNumber(::JSScriptException* jse);
    ...
    static ::JSValue* GetProperty(::JSArray* arr, ::JSContext* context, int32_t index, ::g::Fuse::Scripting::V8::AutoReleasePool pool, uDelegate* errorHandler);
    ...
    static int32_t Length(::JSArray* arr, ::JSContext* context);
    ...
    static ::JSObject* NewExternalArrayBuffer(::JSContext* context, void* data, int32_t byteLength, ::g::Fuse::Scripting::V8::AutoReleasePool pool);
    static ::JSValue* NewInt(int32_t value, ::g::Fuse::Scripting::V8::AutoReleasePool pool);
    ...
    static void SetProperty(::JSArray* arr, ::JSContext* context, int32_t index, ::JSValue* value, uDelegate* errorHandler);
