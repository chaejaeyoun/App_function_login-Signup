// This file was generated based on /usr/local/share/uno/Packages/Fuse.Nodes/1.10.0-rc1/Visual.BeginRemove.uno.
...
struct Visual_type : ::g::Fuse::Node_type
{
    ...
    void(*fp_IsMarginBoxDependent)(::g::Fuse::Visual*, ::g::Fuse::Visual*, int32_t*);
    ...
    void(*fp_get_VisualContext)(::g::Fuse::Visual*, int32_t*);
};
...
struct Visual : ::g::Fuse::Node
{
    ...
    int32_t _transformCount;
    uStrong< ::g::Fuse::FastMatrix*> _worldTransformInverse;
    int32_t _worldTransformVersion;
    int32_t _parentWorldTransformVersion;
    ...
    int32_t _lastInvalidate;
    int32_t _wtiListeners;
    bool _wtiRooted;
    float _zOffset;
    uStrong<uArray*> _cachedZOrder;
    int32_t _naturalZOrder;
    bool _zOrderFixed;
    ...
    uStrong<uDelegate*> LostMarginBox1;
    ...
    void AddEventHandler(::g::Fuse::PropertyHandle* ph, int32_t ne, uObject* handler);
    ...
    void CancelInteractions(int32_t how);
    ...
    void Children_Insert(int32_t index, ::g::Fuse::Node* newNode);
    void Children_InsertAfter(::g::Fuse::Node* preceeder, ::g::Fuse::Node* newNode);
    void Children_Invalidate();
    ::g::Fuse::Node* Children_ItemAt(int32_t index);
    ::g::Fuse::Node* Children_ItemBefore(int32_t index);
    ...
    void Clear(int32_t p);
    void Clear1(int32_t p);
    void ClearBit(int32_t p);
    void ClearBit1(int32_t p);
    void ClearBit2(int32_t nb);
    void ClearLayout();
    void ClearMarginBox();
    ...
    ::g::Fuse::FastProperty1Link1* Find(uType* __type, int32_t p);
    ::g::Fuse::FastProperty2Link1* Find1(uType* __type, int32_t p);
    ::g::Fuse::FastProperty1Link* FindPrevious(int32_t p);
    ::g::Fuse::FastProperty2Link* FindPrevious1(int32_t p);
    ::g::Uno::UX::Template* FindTemplate(uString* key);
    uObject* FindViewport();
    ::g::Fuse::Node* FirstChild(uType* __type);
    template<class T>
    T Get(uType* __type, int32_t p, T defaultValue) { T __retval; return Visual__Get_fn(this, __type, &p, uConstrain(__type->U(0), defaultValue), &__retval), __retval; }
    template<class T>
    T Get1(uType* __type, int32_t p, T defaultValue) { T __retval; return Visual__Get1_fn(this, __type, &p, uConstrain(__type->U(0), defaultValue), &__retval), __retval; }
    ...
    bool HasBit(int32_t p);
    bool HasBit1(int32_t p);
    bool HasBit2(int32_t nb);
    bool HasChildren();
    ...
    void Insert1(int32_t index, ::g::Fuse::Node* item);
    template<class T>
    ...
    void InvalidateLayout(int32_t reason);
    ...
    int32_t IsMarginBoxDependent(Visual* child) { int32_t __retval; return (((Visual_type*)__type)->fp_IsMarginBoxDependent)(this, child, &__retval), __retval; }
    bool IsVisible();
    ...
    void add_LostMarginBox(uDelegate* value);
    void remove_LostMarginBox(uDelegate* value);
    ...
    void RaiseEvent(::g::Fuse::PropertyHandle* ph, int32_t ne);
    void RearrangeMarginBox();
    bool Remove1(::g::Fuse::Node* item);
    void RemoveAllChildren(uType* __type);
    void RemoveDrawCost(double cost);
    void RemoveEventHandler(::g::Fuse::PropertyHandle* ph, int32_t ne, uObject* handler);
    ...
    template<class T>
    void Set(uType* __type, int32_t p, T value, T defaultValue) { Visual__Set_fn(this, __type, &p, uConstrain(__type->U(0), value), uConstrain(__type->U(0), defaultValue)); }
    template<class T>
    void Set1(uType* __type, int32_t p, T value, T defaultValue) { Visual__Set1_fn(this, __type, &p, uConstrain(__type->U(0), value), uConstrain(__type->U(0), defaultValue)); }
    void SetBit(int32_t p);
    void SetBit1(int32_t p, bool value);
    void SetBit2(int32_t p);
    void SetBit3(int32_t p, bool value);
    void SetBit4(int32_t nb);
    ...
    void UpdateLayout();
    int32_t ValidFrameCount();
    ::g::Fuse::Controls::Native::ViewHandle* ViewHandle();
    void ViewHandle(::g::Fuse::Controls::Native::ViewHandle* value);
    uObject* Viewport();
    int32_t VisualChildCount();
    uObject* VisualChildren();
    int32_t VisualContext() { int32_t __retval; return (((Visual_type*)__type)->fp_get_VisualContext)(this, &__retval), __retval; }
    ...
    static int32_t IsMarginBoxDependent(Visual* __this, Visual* child) { int32_t __retval; return Visual__IsMarginBoxDependent_fn(__this, child, &__retval), __retval; }
    ...
    static void onParameterChanged(Visual* v, uArray* args);
    ...
    static int32_t ZOrderComparator(Visual* a, Visual* b);
    ...
    static int32_t VisualContext(Visual* __this) { int32_t __retval; return Visual__get_VisualContext_fn(__this, &__retval), __retval; }
};
