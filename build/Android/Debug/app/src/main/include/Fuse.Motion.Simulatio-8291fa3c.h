// This file was generated based on /usr/local/share/uno/Packages/Fuse.Motion/1.10.0-rc1/Simulation/Friction.uno.
...
struct Friction : uObject
{
    ...
    static Friction* CreateUnit(uType* __type, int32_t unit);
