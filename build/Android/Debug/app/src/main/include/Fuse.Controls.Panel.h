// This file was generated based on /usr/local/share/uno/Packages/Fuse.Controls.Panels/1.10.0-rc1/Panel.Freeze.uno.
...
struct Panel : ::g::Fuse::Controls::LayoutControl
{
    ...
    int32_t DeferFreeze();
    void DeferFreeze(int32_t value);
    void EndBusy();
    void FreezeRooted();
    void FreezeUnrooted();
