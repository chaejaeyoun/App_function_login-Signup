// This file was generated based on /usr/local/share/uno/Packages/UnoCore/1.10.0-rc1/Source/Uno/Int4.uno.
...
struct Int4
{
    ...
    void ctor_2(int32_t x, int32_t y, int32_t z, int32_t w);
    void ctor_7(::g::Uno::Int2 xy, ::g::Uno::Int2 zw);
