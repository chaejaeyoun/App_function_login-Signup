// This file was generated based on /usr/local/share/uno/Packages/Uno.Net.Http/1.10.0-rc1/Implementation/Android/ExperimentalHttp/HttpRequest.uno.
...
struct HttpRequest_type : ::g::Android::Base::Wrappers::JWrapper_type
{
    ...
    void(*fp_OnDataReceived)(::g::Android::com::fuse::ExperimentalHttp::HttpRequest*, uObject*, int32_t*);
    ...
    void(*fp_OnProgress)(::g::Android::com::fuse::ExperimentalHttp::HttpRequest*, int32_t*, int32_t*, bool*);
...
struct HttpRequest : ::g::Android::Base::Wrappers::JWrapper
{
    ...
    void OnDataReceived(uObject* arg0, int32_t arg1) { (((HttpRequest_type*)__type)->fp_OnDataReceived)(this, arg0, &arg1); }
    ...
    void OnProgress(int32_t arg0, int32_t arg1, bool arg2) { (((HttpRequest_type*)__type)->fp_OnProgress)(this, &arg0, &arg1, &arg2); }
    ...
    void SetResponseType(int32_t arg0);
    void SetTimeout(int32_t arg0);
    static void _Init1();
    ...
    static int32_t GetResponseStatus_IMPL_44306(bool arg0_, jobject arg1_);
    ...
    static void SetResponseType_IMPL_44292(bool arg0_, jobject arg1_, int32_t arg2_);
    static void SetTimeout_IMPL_44294(bool arg0_, jobject arg1_, int32_t arg2_);
};
// }
