// This file was generated based on /usr/local/share/uno/Packages/Fuse.Animations/1.10.0-rc1/TriggerAnimation.uno.
...
struct TriggerAnimationState : uObject
{
    ...
    void Dispose();
    ::g::Fuse::Animations::Player* GetCurrentPlayer(int32_t tendTo, int32_t flags);
    ::g::Fuse::Animations::Player* GetPlayer(int32_t variant, bool noFade);
    bool IsStable();
    void OnTimeChanged();
    void PlayEnd(bool on);
    void PlayOff();
    void PlayOn();
    void PlayToProgress(double progress, int32_t tendTo, int32_t flags);
    double Progress();
    bool ProgressFullOff();
    bool ProgressFullOn();
    void SeekProgress(double newProgress, int32_t tendTo, int32_t flags);
