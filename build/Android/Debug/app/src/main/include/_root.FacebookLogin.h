...
namespace g{struct FacebookLogin;}
...
struct FacebookLogin : ::g::Fuse::Controls::Panel
{
    ...
    static uSStrong<uArray*>& __g_static_nametable1() { return FacebookLogin_typeof()->Init(), __g_static_nametable1_; }
    static ::g::Uno::UX::Selector __selector0_;
    static ::g::Uno::UX::Selector& __selector0() { return FacebookLogin_typeof()->Init(), __selector0_; }
    static ::g::Uno::UX::Selector __selector1_;
    static ::g::Uno::UX::Selector& __selector1() { return FacebookLogin_typeof()->Init(), __selector1_; }
    static ::g::Uno::UX::Selector __selector2_;
    static ::g::Uno::UX::Selector& __selector2() { return FacebookLogin_typeof()->Init(), __selector2_; }
    static ::g::Uno::UX::Selector __selector3_;
    static ::g::Uno::UX::Selector& __selector3() { return FacebookLogin_typeof()->Init(), __selector3_; }
    static ::g::Uno::UX::Selector __selector4_;
    static ::g::Uno::UX::Selector& __selector4() { return FacebookLogin_typeof()->Init(), __selector4_; }
    static ::g::Uno::UX::Selector __selector5_;
    static ::g::Uno::UX::Selector& __selector5() { return FacebookLogin_typeof()->Init(), __selector5_; }

    void ctor_7(::g::Fuse::Navigation::Router* router1);
    void InitializeUX();
    static FacebookLogin* New4(::g::Fuse::Navigation::Router* router1);
};
// }
