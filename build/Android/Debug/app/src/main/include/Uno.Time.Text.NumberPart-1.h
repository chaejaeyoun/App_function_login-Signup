// This file was generated based on /usr/local/share/uno/Packages/UnoCore/1.10.0-rc1/Source/Uno/Time/Text/PatternPart.uno.
...
{
    void ctor_1(int32_t size, bool obligatory, uDelegate* setter, uDelegate* getter);
    static NumberPart* New1(uType* __type, int32_t size, bool obligatory, uDelegate* setter, uDelegate* getter);
};
// }
