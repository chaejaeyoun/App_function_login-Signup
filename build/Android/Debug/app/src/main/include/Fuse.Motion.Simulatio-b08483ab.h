// This file was generated based on /usr/local/share/uno/Packages/Fuse.Motion/1.10.0-rc1/Simulation/EasingMotion.uno.
...
struct EasingMotion : uObject
{
    ...
    static EasingMotion* CreateUnit(uType* __type, int32_t unit);
