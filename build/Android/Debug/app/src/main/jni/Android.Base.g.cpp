...
// /usr/local/share/uno/Packages/UnoCore/1.10.0-rc1/Targets/Android/Uno/Base/JNI.uno
// ---------------------------------------------------------------------------------
...
{
    ::g::Uno::Diagnostics::Debug::Assert(JNI::_inited_, uString::Const("Android.Base.JNI._inited"), uString::Const("/usr/local/share/uno/Packages/UnoCore/1.10.0-rc1/Targets/Android/Uno/Base/JNI.uno"), 296, uArray::New(uObject_typeof()->Array(), 0));
...
{
    ::g::Uno::Diagnostics::Debug::Assert(JNI::_inited_, uString::Const("Android.Base.JNI._inited"), uString::Const("/usr/local/share/uno/Packages/UnoCore/1.10.0-rc1/Targets/Android/Uno/Base/JNI.uno"), 109, uArray::New(uObject_typeof()->Array(), 0));
    jclass result;
