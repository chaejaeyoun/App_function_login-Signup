...
{
    MainView__Template1::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"SignUp"*/]);
}

static void MainView__Template1_build(uType* type)
{
    ::STRINGS[0] = uString::Const("SignUp");
...
{
    ::g::SignUp* __self1 = ::g::SignUp::New4(uPtr(__this->__parent1)->router);
