...
// /usr/local/share/uno/Packages/Fuse.Elements/1.10.0-rc1/Triggers/Actions/BringIntoView.uno
// -----------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls/1.10.0-rc1/Triggers/BringToFront.uno
// --------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.10.0-rc1/Actions/Callback.uno
// ---------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.10.0-rc1/Actions/CancelInteractions.uno
// -------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.10.0-rc1/Actions/Visibility.uno
// -----------------------------------------------------------------------------
...
static void Collapse_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.10.0-rc1/Actions/Visibility.uno");
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.10.0-rc1/Actions/DebugAction.uno
// ------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.10.0-rc1/Actions/DebugProperty.uno
// --------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.WebView/1.10.0-rc1/EvaluateJS.uno
// -----------------------------------------------------------------------------
...
// public generated EvaluateJS() :104
...
// private string PrepareScriptForEval(string js) :129
...
// public generated EvaluateJS() [instance] :104
...
// public string get_JavaScript() [instance] :120
uString* EvaluateJS::JavaScript()
{
    return _rawSource;
}

// public void set_JavaScript(string value) [instance] :121
...
// private string PrepareScriptForEval(string js) [instance] :129
...
// public generated EvaluateJS New() [static] :104
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.10.0-rc1/Actions/Focus.uno
// ------------------------------------------------------------------------
...
void Hide__Perform_fn(Hide* __this, ::g::Fuse::Node* target)
{
    ...
    if (t != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[7/*"Cannot find...*/], __this, ::STRINGS[1/*"/usr/local/...*/], 74, ::STRINGS[2/*"Perform"*/], NULL);
}
// }
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.10.0-rc1/Actions/Toggle.uno
// -------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.WebView/1.10.0-rc1/WebViewNavActions.uno
// ------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.10.0-rc1/Actions/Pulse.uno
// ------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.UserEvents/1.10.0-rc1/RaiseUserEvent.uno
// ---------------------------------------------------------------------------
...
static void RaiseUserEvent_build(uType* type)
{
    ...
    ::STRINGS[10] = uString::Const("/usr/local/share/uno/Packages/Fuse.UserEvents/1.10.0-rc1/RaiseUserEvent.uno");
    ::STRINGS[2] = uString::Const("Perform");
...
void RaiseUserEvent__Perform_fn(RaiseUserEvent* __this, ::g::Fuse::Node* target)
{
    ...
    if (__this->_event == NULL)
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[9/*"no UserEven...*/], ::g::Uno::UX::Selector__op_Implicit1(__this->EventName())), __this, ::STRINGS[10/*"/usr/local/...*/], 86, ::STRINGS[2/*"Perform"*/], NULL);
    else
...
// /usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.10.0-rc1/NavigationActions.uno
// ---------------------------------------------------------------------------------------
...
static void ReleasePage_build(uType* type)
{
    ...
    ::STRINGS[12] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.10.0-rc1/NavigationActions.uno");
    ::STRINGS[2] = uString::Const("Perform");
    ::TYPES[1] = ::g::Fuse::Node_typeof()->MakeMethod(1/*FindByType<Fuse.Visual>*/, ::g::Fuse::Visual_typeof(), NULL);
...
void ReleasePage__Perform_fn(ReleasePage* __this, ::g::Fuse::Node* n)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[11/*"Requires a ...*/], __this, ::STRINGS[12/*"/usr/local/...*/], 26, ::STRINGS[2/*"Perform"*/], NULL);
        return;
    }
...
void Show__Perform_fn(Show* __this, ::g::Fuse::Node* target)
{
    ...
    if (t != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[13/*"Cannot find...*/], __this, ::STRINGS[1/*"/usr/local/...*/], 38, ::STRINGS[2/*"Perform"*/], NULL);
}
// }
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.10.0-rc1/Actions/TimelineAction.uno
// ---------------------------------------------------------------------------------
...
static void TimelineAction_build(uType* type)
{
    ...
    ::STRINGS[15] = uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.10.0-rc1/Actions/TimelineAction.uno");
    ::STRINGS[2] = uString::Const("Perform");
    type->SetInterfaces(
        ::g::Fuse::ISourceLocation_typeof(), offsetof(::g::Fuse::Triggers::Actions::TriggerAction_type, interface0));
    type->SetFields(10,
...
void TimelineAction__Perform_fn(TimelineAction* __this, ::g::Fuse::Node* target)
{
    ...
    if (t == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[14/*"`TimelineAc...*/], __this, ::STRINGS[15/*"/usr/local/...*/], 48, ::STRINGS[2/*"Perform"*/], NULL);
        return;
    }
...
static void Toggle_build(uType* type)
{
    ...
    ::STRINGS[17] = uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.10.0-rc1/Actions/Toggle.uno");
    ::STRINGS[2] = uString::Const("Perform");
...
void Toggle__Perform_fn(Toggle* __this, ::g::Fuse::Node* target)
{
    ...
    if (t == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[16/*"Could not f...*/], __this, ::STRINGS[17/*"/usr/local/...*/], 41, ::STRINGS[2/*"Perform"*/], NULL);
        return;
    }
...
static void TransitionLayout_build(uType* type)
{
    ...
    ::STRINGS[19] = uString::Const("/usr/local/share/uno/Packages/Fuse.Elements/1.10.0-rc1/Triggers/LayoutAnimation.uno");
    ::STRINGS[2] = uString::Const("Perform");
    ::TYPES[0] = ::g::Fuse::Elements::Element_typeof();
    ::TYPES[1] = ::g::Fuse::Node_typeof()->MakeMethod(1/*FindByType<Fuse.Visual>*/, ::g::Fuse::Visual_typeof(), NULL);
    ::TYPES[25] = ::g::Uno::Action_typeof();
...
void TransitionLayout__Perform_fn(TransitionLayout* __this, ::g::Fuse::Node* target)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[18/*"Missing `Fr...*/], __this, ::STRINGS[19/*"/usr/local/...*/], 355, ::STRINGS[2/*"Perform"*/], NULL);
        return;
    }
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.10.0-rc1/Actions/StateTransition.uno
// ----------------------------------------------------------------------------------
...
static void TransitionState_build(uType* type)
{
    ...
    ::STRINGS[21] = uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.10.0-rc1/Actions/StateTransition.uno");
    ::STRINGS[2] = uString::Const("Perform");
    type->SetInterfaces(
        ::g::Fuse::ISourceLocation_typeof(), offsetof(::g::Fuse::Triggers::Actions::TriggerAction_type, interface0));
    type->SetFields(10,
...
void TransitionState__Perform_fn(TransitionState* __this, ::g::Fuse::Node* target)
{
    ...
    if (t == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[20/*"Missing `Ta...*/], __this, ::STRINGS[21/*"/usr/local/...*/], 24, ::STRINGS[2/*"Perform"*/], NULL);
        return;
    }
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.10.0-rc1/Actions/TriggerAction.uno
// --------------------------------------------------------------------------------
