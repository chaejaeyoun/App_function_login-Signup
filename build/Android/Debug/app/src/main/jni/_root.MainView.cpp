...
// private void InitializeUX() :230
void MainView__InitializeUX_fn(MainView* __this)
{
    __this->InitializeUX();
}

// public MainView New() :226
...
// private void InitializeUX() [instance] :230
void MainView::InitializeUX()
{
    ...
    MainView__Template1* SignUp = MainView__Template1::New2(this, this);
    MainView__Template2* result = MainView__Template2::New2(this, this);
    MainView__Template3* FacebookLogin = MainView__Template3::New2(this, this);
    uPtr(router)->Name(MainView::__selector0_);
    uPtr(router)->SourceLineNumber(2);
    uPtr(router)->SourceFileName(uString::Const("MainView.ux"));
    temp->DefaultPath(uString::Const("FacebookLogin"));
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp->Templates()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL)), SignUp);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp->Templates()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL)), result);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp->Templates()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL)), FacebookLogin);
...
// public MainView New() [static] :226
