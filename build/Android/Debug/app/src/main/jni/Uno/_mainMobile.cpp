...
namespace g{uClassType* FuseCommon_bundle_typeof();}
...
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseControlsNavigation_FuseElementsElement_HitTestMode_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* FuseControlsPanels_FuseElementsElement_Padding_Property_typeof();}
...
namespace g{uClassType* App_LoginSignup_bundle_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* App_LoginSignup_FuseControlsTextControl_Value_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* App_LoginSignup_FuseControlsTextInputControl_Value_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* App_LoginSignup_FuseControlsWebView_Url_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* App_LoginSignup_FuseDrawingImageFill_Url_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* App_LoginSignup_FuseElementsElement_Opacity_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* App_LoginSignup_FuseTriggersActionsDebugAction_Message_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* App_LoginSignup_FuseTriggersWhileBool_Value_Property_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* FacebookLogin_typeof();}
...
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* result_typeof();}
namespace g{namespace Fuse{namespace Controls{struct Panel_type;}} ::g::Fuse::Controls::Panel_type* SignUp_typeof();}
...
namespace g{namespace OpenGL{uEnumType* GLBufferTarget_typeof();}}
namespace g{namespace OpenGL{uEnumType* GLBufferUsage_typeof();}}
namespace g{namespace OpenGL{uEnumType* GLClearBufferMask_typeof();}}
namespace g{namespace OpenGL{uEnumType* GLCullFaceMode_typeof();}}
namespace g{namespace OpenGL{uEnumType* GLDataType_typeof();}}
namespace g{namespace OpenGL{uEnumType* GLDepthFunction_typeof();}}
namespace g{namespace OpenGL{uEnumType* GLEnableCap_typeof();}}
namespace g{namespace OpenGL{uEnumType* GLError_typeof();}}
namespace g{namespace OpenGL{uEnumType* GLFramebufferAttachment_typeof();}}
namespace g{namespace OpenGL{uStructType* GLFramebufferHandle_typeof();}}
namespace g{namespace OpenGL{uEnumType* GLFramebufferStatus_typeof();}}
namespace g{namespace OpenGL{uEnumType* GLFramebufferTarget_typeof();}}
namespace g{namespace OpenGL{uEnumType* GLFrontFaceDirection_typeof();}}
namespace g{namespace OpenGL{uEnumType* GLIndexType_typeof();}}
namespace g{namespace OpenGL{uEnumType* GLInteger4Name_typeof();}}
namespace g{namespace OpenGL{uEnumType* GLIntegerName_typeof();}}
namespace g{namespace OpenGL{uEnumType* GLPixelFormat_typeof();}}
namespace g{namespace OpenGL{uEnumType* GLPixelType_typeof();}}
namespace g{namespace OpenGL{uEnumType* GLPrimitiveType_typeof();}}
namespace g{namespace OpenGL{uStructType* GLProgramHandle_typeof();}}
namespace g{namespace OpenGL{uEnumType* GLProgramParameter_typeof();}}
namespace g{namespace OpenGL{uStructType* GLRenderbufferHandle_typeof();}}
namespace g{namespace OpenGL{uEnumType* GLRenderbufferStorage_typeof();}}
namespace g{namespace OpenGL{uEnumType* GLRenderbufferTarget_typeof();}}
namespace g{namespace OpenGL{uStructType* GLShaderHandle_typeof();}}
namespace g{namespace OpenGL{uEnumType* GLShaderParameter_typeof();}}
namespace g{namespace OpenGL{uEnumType* GLShaderType_typeof();}}
namespace g{namespace OpenGL{uEnumType* GLStringName_typeof();}}
namespace g{namespace OpenGL{uStructType* GLTextureHandle_typeof();}}
namespace g{namespace OpenGL{uEnumType* GLTextureParameterName_typeof();}}
namespace g{namespace OpenGL{uEnumType* GLTextureParameterValue_typeof();}}
namespace g{namespace OpenGL{uEnumType* GLTextureTarget_typeof();}}
namespace g{namespace OpenGL{uEnumType* GLTextureUnit_typeof();}}
namespace g{namespace Uno{uDelegateType* Action_typeof();}}
namespace g{namespace Uno{uDelegateType* Action1_typeof();}}
namespace g{namespace Uno{uDelegateType* Action2_typeof();}}
namespace g{namespace Uno{uDelegateType* Action3_typeof();}}
namespace g{namespace Uno{uDelegateType* Action4_typeof();}}
...
namespace g{namespace Uno{uDelegateType* EventHandler1_typeof();}}
...
namespace g{namespace Uno{uDelegateType* Func_typeof();}}
namespace g{namespace Uno{uDelegateType* Func1_typeof();}}
namespace g{namespace Uno{uDelegateType* Func2_typeof();}}
namespace g{namespace Uno{uDelegateType* Func3_typeof();}}
...
namespace g{namespace Uno{uInterfaceType* IDisposable_typeof();}}
...
namespace g{namespace Uno{uInterfaceType* ITuple_typeof();}}
...
namespace g{namespace Uno{uDelegateType* Predicate_typeof();}}
...
namespace g{namespace Uno{struct Exception_type; ::g::Uno::Exception_type* TypeInitializationException_typeof();}}
...
namespace g{namespace Uno{namespace Collections{uEnumType* Dictionary__BucketState_typeof();}}}
...
namespace g{namespace Uno{namespace Collections{uInterfaceType* IEnumerable_typeof();}}}
namespace g{namespace Uno{namespace Collections{uInterfaceType* IEnumerator_typeof();}}}
namespace g{namespace Uno{namespace Collections{uInterfaceType* IEnumerator1_typeof();}}}
namespace g{namespace Uno{namespace Collections{uInterfaceType* IList_typeof();}}}
...
namespace g{namespace Uno{namespace Collections{uEnumType* PriorityQueueType_typeof();}}}
...
namespace g{namespace Uno{namespace Diagnostics{uDelegateType* AssertionHandler_typeof();}}}
...
namespace g{namespace Uno{namespace Diagnostics{uEnumType* DebugMessageType_typeof();}}}
namespace g{namespace Uno{namespace Diagnostics{uDelegateType* LogHandler_typeof();}}}
namespace g{namespace Uno{namespace Graphics{uEnumType* BlendEquation_typeof();}}}
namespace g{namespace Uno{namespace Graphics{uEnumType* BlendOperand_typeof();}}}
namespace g{namespace Uno{namespace Graphics{uEnumType* BufferUsage_typeof();}}}
namespace g{namespace Uno{namespace Graphics{uEnumType* CompareFunc_typeof();}}}
namespace g{namespace Uno{namespace Graphics{struct DeviceBuffer_type; DeviceBuffer_type* DeviceBuffer_typeof();}}}
namespace g{namespace Uno{namespace Graphics{uEnumType* Format_typeof();}}}
...
namespace g{namespace Uno{namespace Graphics{uEnumType* FramebufferFlags_typeof();}}}
...
namespace g{namespace Uno{namespace Graphics{uEnumType* IndexType_typeof();}}}
namespace g{namespace Uno{namespace Graphics{uEnumType* PolygonFace_typeof();}}}
namespace g{namespace Uno{namespace Graphics{uEnumType* PolygonWinding_typeof();}}}
namespace g{namespace Uno{namespace Graphics{uEnumType* PrimitiveType_typeof();}}}
...
namespace g{namespace Uno{namespace Graphics{uEnumType* TextureAddressMode_typeof();}}}
namespace g{namespace Uno{namespace Graphics{uEnumType* TextureFilter_typeof();}}}
...
namespace g{namespace Uno{namespace IO{uEnumType* UserDirectory_typeof();}}}
namespace g{namespace Uno{namespace Platform{struct Display_type; ::g::Uno::Platform::Display_type* AndroidDisplay_typeof();}}}
namespace g{namespace Uno{namespace Platform{uEnumType* ApplicationState_typeof();}}}
namespace g{namespace Uno{namespace Platform{uDelegateType* ApplicationStateTransitionHandler_typeof();}}}
...
namespace g{namespace Uno{namespace Platform{uEnumType* EventModifiers_typeof();}}}
namespace g{namespace Uno{namespace Platform{uEnumType* Key_typeof();}}}
...
namespace g{namespace Uno{namespace Platform{uEnumType* PointerType_typeof();}}}
...
namespace g{namespace Uno{namespace Runtime{namespace Implementation{namespace Internal{uEnumType* FormatStringTokenizer__State_typeof();}}}}}
...
namespace g{namespace Uno{namespace Threading{uEnumType* EventResetMode_typeof();}}}
...
namespace g{namespace Uno{namespace Threading{uEnumType* FutureState_typeof();}}}
namespace g{namespace Uno{namespace Threading{uInterfaceType* IDispatcher_typeof();}}}
namespace g{namespace Uno{namespace Threading{uInterfaceType* ITaskScheduler_typeof();}}}
...
namespace g{namespace Uno{namespace Threading{uDelegateType* TaskDelegate_typeof();}}}
...
namespace g{namespace Uno{namespace Time{uStructType* LocalDateTime_typeof();}}}
...
namespace g{namespace Uno{namespace Time{namespace Text{uInterfaceType* IPatternPart_typeof();}}}}
...
namespace g{namespace Uno{namespace UX{uDelegateType* Expression_typeof();}}}
namespace g{namespace Uno{namespace UX{struct FileSource_type; FileSource_type* FileSource_typeof();}}}
namespace g{namespace Uno{namespace UX{uInterfaceType* IPropertyListener_typeof();}}}
...
namespace g{namespace Uno{namespace UX{uEnumType* Unit_typeof();}}}
namespace g{namespace Uno{namespace UX{uType* ValueChangedArgs_typeof();}}}
namespace g{namespace Uno{namespace UX{uDelegateType* ValueChangedHandler_typeof();}}}
...
namespace g{namespace Uno{namespace Data{namespace Json{uEnumType* JsonDataType_typeof();}}}}
...
namespace g{namespace Uno{namespace Net{namespace Sockets{uEnumType* SocketFlags_typeof();}}}}
...
namespace g{namespace Uno{namespace Net{namespace Http{uEnumType* HttpRequestState_typeof();}}}}
namespace g{namespace Uno{namespace Net{namespace Http{uEnumType* HttpResponseType_typeof();}}}}
...
namespace g{namespace Android{namespace Base{uEnumType* JNI__RefType_typeof();}}}
...
namespace g{namespace Android{namespace Base{namespace Wrappers{uInterfaceType* IJWrapper_typeof();}}}}
...
namespace g{namespace Fuse{uType* BoolComputer_typeof();}}
namespace g{namespace Fuse{uStructType* Box_typeof();}}
namespace g{namespace Fuse{uType* CacheFramebuffer_typeof();}}
namespace g{namespace Fuse{uEnumType* Visual__CancelInteractionsType_typeof();}}
...
namespace g{namespace Fuse{uEnumType* NodeGroupBase__ConstructFlags_typeof();}}
namespace g{namespace Fuse{uEnumType* Node__ContextDataResult_typeof();}}
namespace g{namespace Fuse{uEnumType* Node__DataType_typeof();}}
...
namespace g{namespace Fuse{uDelegateType* DiagnosticHandler_typeof();}}
namespace g{namespace Fuse{uClassType* Diagnostics_typeof();}}
namespace g{namespace Fuse{uEnumType* DiagnosticType_typeof();}}
...
namespace g{namespace Fuse{uEnumType* LayoutParams__Flags_typeof();}}
...
namespace g{namespace Fuse{uDelegateType* HitTestCallback_typeof();}}
...
namespace g{namespace Fuse{uEnumType* Visual__HitTestTransformMode_typeof();}}
namespace g{namespace Fuse{uInterfaceType* IActualPlacement_typeof();}}
namespace g{namespace Fuse{uInterfaceType* IArray_typeof();}}
namespace g{namespace Fuse{uInterfaceType* IBeginRemoveVisualListener_typeof();}}
namespace g{namespace Fuse{uInterfaceType* ICommonViewport_typeof();}}
namespace g{namespace Fuse{uInterfaceType* Marshal__IConverter_typeof();}}
namespace g{namespace Fuse{uInterfaceType* Node__IDataListener_typeof();}}
namespace g{namespace Fuse{uInterfaceType* IDeferred_typeof();}}
...
namespace g{namespace Fuse{uInterfaceType* IFrame_typeof();}}
namespace g{namespace Fuse{uInterfaceType* IFrustum_typeof();}}
namespace g{namespace Fuse{uInterfaceType* ILoading_typeof();}}
namespace g{namespace Fuse{uClassType* ILoadingStatic_typeof();}}
namespace g{namespace Fuse{uInterfaceType* INameListener_typeof();}}
namespace g{namespace Fuse{uInterfaceType* INotifyUnrooted_typeof();}}
namespace g{namespace Fuse{uStructType* Visual__InteractionItem_typeof();}}
namespace g{namespace Fuse{uEnumType* InvalidateLayoutReason_typeof();}}
namespace g{namespace Fuse{uInterfaceType* IObject_typeof();}}
namespace g{namespace Fuse{uInterfaceType* IParentObserver_typeof();}}
namespace g{namespace Fuse{uInterfaceType* IPreviewStateSaver_typeof();}}
namespace g{namespace Fuse{uInterfaceType* IProperties_typeof();}}
...
namespace g{namespace Fuse{uInterfaceType* ITransformRelative_typeof();}}
namespace g{namespace Fuse{uInterfaceType* ITranslationMode_typeof();}}
namespace g{namespace Fuse{uInterfaceType* IUpdateListener_typeof();}}
namespace g{namespace Fuse{uInterfaceType* IViewport_typeof();}}
...
namespace g{namespace Fuse{uEnumType* Layer_typeof();}}
namespace g{namespace Fuse{uEnumType* LayoutDependent_typeof();}}
namespace g{namespace Fuse{uStructType* LayoutParams_typeof();}}
namespace g{namespace Fuse{uEnumType* LayoutPriority_typeof();}}
namespace g{namespace Fuse{uEnumType* LayoutRole_typeof();}}
...
namespace g{namespace Fuse{uType* LostMarginBoxArgs_typeof();}}
namespace g{namespace Fuse{uDelegateType* LostMarginBoxHandler_typeof();}}
...
namespace g{namespace Fuse{struct Node__NodeDataSubscription_type; Node__NodeDataSubscription_type* Node__NodeDataSubscription_typeof();}}
...
namespace g{namespace Fuse{uDelegateType* PlacedHandler_typeof();}}
...
namespace g{namespace Fuse{uDelegateType* RequestBringIntoViewHandler_typeof();}}
namespace g{namespace Fuse{uEnumType* RootStage_typeof();}}
...
namespace g{namespace Fuse{uEnumType* SystemFont__Style_typeof();}}
...
namespace g{namespace Fuse{uEnumType* VisualBounds__Type_typeof();}}
namespace g{namespace Fuse{uType* UnhandledExceptionArgs_typeof();}}
namespace g{namespace Fuse{uDelegateType* UnhandledExceptionHandler_typeof();}}
...
namespace g{namespace Fuse{uEnumType* UpdateStage_typeof();}}
...
namespace g{namespace Fuse{uDelegateType* UserEventHandler_typeof();}}
...
namespace g{namespace Fuse{uEnumType* Visual__VisualBits_typeof();}}
namespace g{namespace Fuse{uType* VisualBounds_typeof();}}
namespace g{namespace Fuse{uEnumType* VisualContext_typeof();}}
...
namespace g{namespace Fuse{uDelegateType* VisualEventHandler_typeof();}}
namespace g{namespace Fuse{uEnumType* VisualEventMode_typeof();}}
namespace g{namespace Fuse{uClassType* VisualListCache_typeof();}}
namespace g{namespace Fuse{uEnumType* SystemFont__Weight_typeof();}}
...
namespace g{namespace Fuse{namespace Platform{uEnumType* ApplicationState_typeof();}}}
...
namespace g{namespace Fuse{namespace Platform{uEnumType* SystemUIResizeReason_typeof();}}}
namespace g{namespace Fuse{namespace Platform{uEnumType* SysUIState_typeof();}}}
namespace g{namespace Fuse{namespace Common{uType* Blitter_typeof();}}}
namespace g{namespace Fuse{namespace Animations{uEnumType* AnimationVariant_typeof();}}}
...
namespace g{namespace Fuse{namespace Animations{uEnumType* AnimatorVariant_typeof();}}}
...
namespace g{namespace Fuse{namespace Animations{uInterfaceType* ContinuousTrackProvider_typeof();}}}
...
namespace g{namespace Fuse{namespace Animations{uEnumType* CycleRestore_typeof();}}}
...
namespace g{namespace Fuse{namespace Animations{uEnumType* CycleWaveform_typeof();}}}
...
namespace g{namespace Fuse{namespace Animations{uInterfaceType* DiscreteTrackProvider_typeof();}}}
...
namespace g{namespace Fuse{namespace Animations{uInterfaceType* IBasePlayerFeedback_typeof();}}}
namespace g{namespace Fuse{namespace Animations{uInterfaceType* IMixer_typeof();}}}
namespace g{namespace Fuse{namespace Animations{uInterfaceType* IMixerHandle_typeof();}}}
namespace g{namespace Fuse{namespace Animations{uInterfaceType* IMixerMaster_typeof();}}}
namespace g{namespace Fuse{namespace Animations{uInterfaceType* IPlayerFeedback_typeof();}}}
namespace g{namespace Fuse{namespace Animations{uInterfaceType* IResize_typeof();}}}
namespace g{namespace Fuse{namespace Animations{uInterfaceType* IResizeMode_typeof();}}}
namespace g{namespace Fuse{namespace Animations{uInterfaceType* IUnwrappedPlayerFeedback_typeof();}}}
...
namespace g{namespace Fuse{namespace Animations{uInterfaceType* MasterPropertyGet_typeof();}}}
...
namespace g{namespace Fuse{namespace Animations{uEnumType* MixOp_typeof();}}}
...
namespace g{namespace Fuse{namespace Animations{uEnumType* PlayerFeedbackFlags_typeof();}}}
namespace g{namespace Fuse{namespace Animations{uType* PlayerPart_typeof();}}}
namespace g{namespace Fuse{namespace Animations{uEnumType* PlayMode_typeof();}}}
...
namespace g{namespace Fuse{namespace Animations{uEnumType* SeekDirection_typeof();}}}
namespace g{namespace Fuse{namespace Animations{uEnumType* TriggerAnimationState__SeekFlags_typeof();}}}
namespace g{namespace Fuse{namespace Animations{uEnumType* SeekResult_typeof();}}}
...
namespace g{namespace Fuse{namespace Animations{uInterfaceType* TrackProvider_typeof();}}}
...
namespace g{namespace Fuse{namespace Animations{uDelegateType* DestinationBehavior__ValueHandler_typeof();}}}
...
namespace g{namespace Fuse{namespace Internal{uEnumType* ObjectList__Equality_typeof();}}}
...
namespace g{namespace Fuse{namespace Internal{uInterfaceType* IImageContainerOwner_typeof();}}}
...
namespace g{namespace Fuse{namespace Internal{uEnumType* MiniListMode_typeof();}}}
...
namespace g{namespace Fuse{namespace Resources{uEnumType* LoadingImageSource__CleanupReason_typeof();}}}
namespace g{namespace Fuse{namespace Resources{uClassType* DisposalManager_typeof();}}}
namespace g{namespace Fuse{namespace Resources{uEnumType* DisposalRequest_typeof();}}}
...
namespace g{namespace Fuse{namespace Resources{uDelegateType* ImageSourceErrorHandler_typeof();}}}
namespace g{namespace Fuse{namespace Resources{uEnumType* ImageSourceState_typeof();}}}
namespace g{namespace Fuse{namespace Resources{uInterfaceType* IMemoryResource_typeof();}}}
namespace g{namespace Fuse{namespace Resources{uInterfaceType* ISoftDisposable_typeof();}}}
...
namespace g{namespace Fuse{namespace Resources{namespace Exif{uEnumType* ImageOrientation_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{uType* NativeEventEmitterModule__ActionClosure_typeof();}}}
...
namespace g{namespace Fuse{namespace Scripting{uType* ScriptMethod1__ArgumentMirrorClosure_typeof();}}}
...
namespace g{namespace Fuse{namespace Scripting{uEnumType* ExecutionThread_typeof();}}}
...
namespace g{namespace Fuse{namespace Scripting{uDelegateType* FutureFactory_typeof();}}}
namespace g{namespace Fuse{namespace Scripting{uDelegateType* ScriptPromise__FutureFactory_typeof();}}}
namespace g{namespace Fuse{namespace Scripting{uInterfaceType* IEventSerializer_typeof();}}}
namespace g{namespace Fuse{namespace Scripting{uInterfaceType* IFunctionMirror_typeof();}}}
namespace g{namespace Fuse{namespace Scripting{uInterfaceType* IModuleProvider_typeof();}}}
namespace g{namespace Fuse{namespace Scripting{uInterfaceType* IRaw_typeof();}}}
namespace g{namespace Fuse{namespace Scripting{uInterfaceType* IScriptEvent_typeof();}}}
namespace g{namespace Fuse{namespace Scripting{uInterfaceType* IScriptObject_typeof();}}}
namespace g{namespace Fuse{namespace Scripting{uInterfaceType* IThreadWorker_typeof();}}}
...
namespace g{namespace Fuse{namespace Scripting{uDelegateType* NativeCallback_typeof();}}}
...
namespace g{namespace Fuse{namespace Scripting{struct SubscriptionSubject__Subscription_type; SubscriptionSubject__Subscription_type* SubscriptionSubject__Subscription_typeof();}}}
...
namespace g{namespace Fuse{namespace Scripting{uDelegateType* ValueConverter_typeof();}}}
namespace g{namespace Fuse{namespace Scripting{struct ValueMirror_type; ValueMirror_type* ValueMirror_typeof();}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{struct Observable__Operation_type; ::g::Fuse::Scripting::JavaScript::Observable__Operation_type* Observable__Add_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{struct TreeObservable__Operation_type; ::g::Fuse::Scripting::JavaScript::TreeObservable__Operation_type* TreeObservable__AddOperation_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{struct ListMirror_type; namespace JavaScript{::g::Fuse::Scripting::ListMirror_type* ArrayMirror_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{struct TreeArray__ArraySubscription_type; TreeArray__ArraySubscription_type* TreeArray__ArraySubscription_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{uType* ClassInstance_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{struct Observable__Operation_type; ::g::Fuse::Scripting::JavaScript::Observable__Operation_type* Observable__Clear_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{uType* Observable__Subscription__ClearExclusiveOperation_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{uType* ThreadWorker__ContextIgnoringAction_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{uClassType* DateTimeConverterHelpers_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{uType* ThreadWorker__ExceptionClosure_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{struct Observable__Operation_type; ::g::Fuse::Scripting::JavaScript::Observable__Operation_type* Observable__Failed_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{uInterfaceType* IMirror_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{struct Observable__Operation_type; ::g::Fuse::Scripting::JavaScript::Observable__Operation_type* Observable__InsertAll_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{struct Observable__Operation_type; ::g::Fuse::Scripting::JavaScript::Observable__Operation_type* Observable__InsertAt_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{struct TreeObservable__Operation_type; ::g::Fuse::Scripting::JavaScript::TreeObservable__Operation_type* TreeObservable__InsertAtOperation_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{struct JSContext_type; JSContext_type* JSContext_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{uType* TreeObject__PropertySubscription__JSThreadSet_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{struct ObservableProperty_type; ::g::Fuse::Scripting::JavaScript::ObservableProperty_type* LazyObservableProperty_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{uType* JSContext__MethodClosure_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{uType* ModuleInstance_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{struct Observable__Operation_type; ::g::Fuse::Scripting::JavaScript::Observable__Operation_type* Observable__NewAll_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{struct Observable__Operation_type; ::g::Fuse::Scripting::JavaScript::Observable__Operation_type* Observable__NewAt_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{struct ObjectMirror_type; ObjectMirror_type* ObjectMirror_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{struct Observable_type; Observable_type* Observable_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{struct ObservableProperty_type; ObservableProperty_type* ObservableProperty_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{struct Observable__Operation_type; Observable__Operation_type* Observable__Operation_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{struct TreeObservable__Operation_type; TreeObservable__Operation_type* TreeObservable__Operation_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{uType* TreeObservable__Operation__PerformClosure_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{uType* JSContext__PropertyClosure_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{struct TreeObject__PropertySubscription_type; TreeObject__PropertySubscription_type* TreeObject__PropertySubscription_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{uType* ObservableProperty__PushCapture_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{uType* JSContext__ReadonlyPropertyClosure_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{struct Observable__Operation_type; ::g::Fuse::Scripting::JavaScript::Observable__Operation_type* Observable__RemoveAt_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{struct TreeObservable__Operation_type; ::g::Fuse::Scripting::JavaScript::TreeObservable__Operation_type* TreeObservable__RemoveAtOperation_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{struct Observable__Operation_type; ::g::Fuse::Scripting::JavaScript::Observable__Operation_type* Observable__RemoveRange_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{uType* Observable__Subscription__ReplaceAllExclusiveOperation_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{uType* TreeArray__ArraySubscription__ReplaceAllOperation_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{uType* ObservableProperty__ResolveDefaultValueClosure_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{struct ScriptModule_type; namespace JavaScript{::g::Fuse::Scripting::ScriptModule_type* RootableScriptModule_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{uEnumType* ScriptModuleNames_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{struct Observable__Operation_type; ::g::Fuse::Scripting::JavaScript::Observable__Operation_type* Observable__Set_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{uType* TreeObject__SetClosure_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{uType* Observable__Subscription__SetExclusiveOperation_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{struct TreeObservable__Operation_type; ::g::Fuse::Scripting::JavaScript::TreeObservable__Operation_type* TreeObservable__SetOperation_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{struct TreeArray__ArraySubscription__SimpleArray_type; TreeArray__ArraySubscription__SimpleArray_type* TreeArray__ArraySubscription__SimpleArray_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{struct Observable__Subscription_type; Observable__Subscription_type* Observable__Subscription_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{struct ThreadWorker_type; ThreadWorker_type* ThreadWorker_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{struct TreeArray_type; TreeArray_type* TreeArray_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{struct TreeObject_type; TreeObject_type* TreeObject_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{struct TreeObservable_type; TreeObservable_type* TreeObservable_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{uClassType* TypeWrapper_typeof();}}}}
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{struct TreeObservable__Operation_type; ::g::Fuse::Scripting::JavaScript::TreeObservable__Operation_type* TreeObservable__ValueOperation_typeof();}}}}
...
namespace g{namespace Fuse{namespace Scripting{namespace JavaScript{struct JSContext_type;}}} namespace Fuse{namespace Scripting{namespace V8{::g::Fuse::Scripting::JavaScript::JSContext_type* Context_typeof();}}}}
...
namespace g{namespace Fuse{namespace Scripting{namespace V8{uDelegateType* V8SimpleExtensions__WrappedCallback_typeof();}}}}
...
namespace g{namespace Fuse{namespace Scripting{namespace V8{namespace Simple{uDelegateType* JSCallback_typeof();}}}}}
...
namespace g{namespace Fuse{namespace Scripting{namespace V8{namespace Simple{uEnumType* JSRuntimeError_typeof();}}}}}
...
namespace g{namespace Fuse{namespace Scripting{namespace V8{namespace Simple{uEnumType* JSType_typeof();}}}}}
...
namespace g{namespace Fuse{namespace Controls{uType* CommonNavigationPages__AddedPage_typeof();}}}
...
namespace g{namespace Fuse{namespace Controls{uClassType* CommonNavigation_typeof();}}}
namespace g{namespace Fuse{namespace Controls{uType* CommonNavigationPages_typeof();}}}
...
namespace g{namespace Fuse{namespace Controls{struct SegmentedShape_type; ::g::Fuse::Controls::SegmentedShape_type* Curve_typeof();}}}
namespace g{namespace Fuse{namespace Controls{uEnumType* CurveClose_typeof();}}}
namespace g{namespace Fuse{namespace Controls{uEnumType* CurveExtrude_typeof();}}}
namespace g{namespace Fuse{struct Node_type; namespace Controls{::g::Fuse::Node_type* CurvePoint_typeof();}}}
namespace g{namespace Fuse{namespace Controls{uEnumType* CurveStyle_typeof();}}}
...
namespace g{namespace Fuse{namespace Controls{uEnumType* FitMode_typeof();}}}
...
namespace g{namespace Fuse{namespace Controls{uEnumType* CurvePoint__HasFlags_typeof();}}}
...
namespace g{namespace Fuse{namespace Controls{uInterfaceType* INativeViewRoot_typeof();}}}
namespace g{namespace Fuse{namespace Controls{uEnumType* NativeViewHost__InitialState_typeof();}}}
...
namespace g{namespace Fuse{namespace Controls{uEnumType* NavigationControlBlockInput_typeof();}}}
namespace g{namespace Fuse{namespace Controls{uEnumType* NavigationControlInactiveState_typeof();}}}
namespace g{namespace Fuse{namespace Controls{uEnumType* NavigationControlInteraction_typeof();}}}
namespace g{namespace Fuse{namespace Controls{uEnumType* NavigationControlTransition_typeof();}}}
namespace g{namespace Fuse{namespace Controls{uDelegateType* NavigationSwitchedHandler_typeof();}}}
namespace g{namespace Fuse{namespace Controls{struct Navigator_type; Navigator_type* Navigator_typeof();}}}
namespace g{namespace Fuse{namespace Controls{uEnumType* NavigatorGotoState_typeof();}}}
namespace g{namespace Fuse{struct Node_type; namespace Controls{::g::Fuse::Node_type* NavigatorSwipe_typeof();}}}
namespace g{namespace Fuse{namespace Controls{uEnumType* NavigatorSwipeDirection_typeof();}}}
namespace g{namespace Fuse{namespace Controls{uEnumType* NavigatorSwipeHow_typeof();}}}
...
namespace g{namespace Fuse{namespace Reactive{struct ObserverMap_type;}} namespace Fuse{namespace Controls{::g::Fuse::Reactive::ObserverMap_type* CommonNavigationPages__PagesMap_typeof();}}}
namespace g{namespace Fuse{namespace Controls{struct Panel_type; Panel_type* Panel_typeof();}}}
namespace g{namespace Fuse{namespace Controls{struct SegmentedShape_type; ::g::Fuse::Controls::SegmentedShape_type* Path_typeof();}}}
namespace g{namespace Fuse{namespace Controls{struct PathExpression_type; PathExpression_type* PathExpression_typeof();}}}
namespace g{namespace Fuse{namespace Controls{uEnumType* PathMeasureMode_typeof();}}}
namespace g{namespace Fuse{namespace Controls{struct PathExpression_type; ::g::Fuse::Controls::PathExpression_type* PathPointAtDistance_typeof();}}}
namespace g{namespace Fuse{namespace Controls{struct PathExpression_type; ::g::Fuse::Controls::PathExpression_type* PathPointAtTime_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct ExpressionListener_type;}} namespace Fuse{namespace Controls{::g::Fuse::Reactive::ExpressionListener_type* PathExpression__PathSubscription_typeof();}}}
namespace g{namespace Fuse{namespace Controls{struct PathExpression_type; ::g::Fuse::Controls::PathExpression_type* PathTangentAngleAtDistance_typeof();}}}
...
namespace g{namespace Fuse{namespace Controls{uEnumType* SingleViewHost__RenderState_typeof();}}}
namespace g{namespace Fuse{namespace Controls{uType* Shape__ResourceWatcher_typeof();}}}
namespace g{namespace Fuse{namespace Controls{uEnumType* ReuseType_typeof();}}}
...
namespace g{namespace Fuse{namespace Controls{uEnumType* ScrollDirections_typeof();}}}
...
namespace g{namespace Fuse{namespace Controls{uDelegateType* ScrollPositionChangedHandler_typeof();}}}
...
namespace g{namespace Fuse{namespace Controls{uEnumType* ScrollViewLayoutMode_typeof();}}}
...
namespace g{namespace Fuse{namespace Controls{uEnumType* TextInputActionType_typeof();}}}
...
namespace g{namespace Fuse{namespace Controls{uEnumType* NavigationControl__UpdateFlags_typeof();}}}
...
namespace g{namespace Fuse{namespace Controls{namespace Native{uInterfaceType* IGraphicsView_typeof();}}}}
namespace g{namespace Fuse{namespace Controls{namespace Native{uInterfaceType* IImageView_typeof();}}}}
namespace g{namespace Fuse{namespace Controls{namespace Native{uInterfaceType* ILabelView_typeof();}}}}
...
namespace g{namespace Fuse{namespace Controls{namespace Native{uInterfaceType* IShapeView_typeof();}}}}
namespace g{namespace Fuse{namespace Controls{namespace Native{uInterfaceType* ITextEdit_typeof();}}}}
namespace g{namespace Fuse{namespace Controls{namespace Native{uInterfaceType* ITextEditHost_typeof();}}}}
namespace g{namespace Fuse{namespace Controls{namespace Native{uInterfaceType* ITextView_typeof();}}}}
namespace g{namespace Fuse{namespace Controls{namespace Native{uInterfaceType* IToggleView_typeof();}}}}
namespace g{namespace Fuse{namespace Controls{namespace Native{uInterfaceType* IToggleViewHost_typeof();}}}}
namespace g{namespace Fuse{namespace Controls{namespace Native{uInterfaceType* IView_typeof();}}}}
namespace g{namespace Fuse{namespace Controls{namespace Native{uInterfaceType* IViewHandleRenderer_typeof();}}}}
namespace g{namespace Fuse{namespace Controls{namespace Native{uInterfaceType* IViewHost_typeof();}}}}
...
namespace g{namespace Fuse{namespace Triggers{struct Trigger_type;}} namespace Fuse{namespace Controls{namespace NavigationInternal{::g::Fuse::Triggers::Trigger_type* BlockInputWhileNavigating_typeof();}}}}
...
namespace g{namespace Fuse{namespace Controls{namespace VideoImpl{uInterfaceType* IVideoCallbacks_typeof();}}}}
namespace g{namespace Fuse{namespace Controls{namespace VideoImpl{uInterfaceType* IVideoPlayer_typeof();}}}}
namespace g{namespace Fuse{namespace Controls{namespace VideoImpl{uInterfaceType* IVideoService_typeof();}}}}
...
namespace g{namespace Fuse{namespace Controls{namespace VideoImpl{uEnumType* VideoVisual__PlaybackTarget_typeof();}}}}
...
namespace g{namespace Fuse{namespace Input{uEnumType* CaptureType_typeof();}}}
...
namespace g{namespace Fuse{namespace Input{uDelegateType* FocusDelegator_typeof();}}}
...
namespace g{namespace Fuse{namespace Input{uDelegateType* FocusGainedHandler_typeof();}}}
...
namespace g{namespace Fuse{namespace Input{uDelegateType* FocusLostHandler_typeof();}}}
namespace g{namespace Fuse{namespace Input{uEnumType* FocusNavigationDirection_typeof();}}}
...
namespace g{namespace Fuse{namespace Input{uEnumType* GesturePriority_typeof();}}}
namespace g{namespace Fuse{namespace Input{uStructType* GesturePriorityConfig_typeof();}}}
namespace g{namespace Fuse{namespace Input{uEnumType* GestureRequest_typeof();}}}
namespace g{namespace Fuse{namespace Input{uClassType* Gestures_typeof();}}}
namespace g{namespace Fuse{namespace Input{uEnumType* GestureType_typeof();}}}
namespace g{namespace Fuse{namespace Input{uClassType* HitTestHelpers_typeof();}}}
namespace g{namespace Fuse{namespace Input{uInterfaceType* IGesture_typeof();}}}
namespace g{namespace Fuse{namespace Input{uInterfaceType* INotifyFocus_typeof();}}}
namespace g{namespace Fuse{namespace Input{uInterfaceType* IPointerEventResponder_typeof();}}}
...
namespace g{namespace Fuse{namespace Input{uDelegateType* IsFocusableChangedHandler_typeof();}}}
...
namespace g{namespace Fuse{namespace Input{uDelegateType* KeyPressedHandler_typeof();}}}
...
namespace g{namespace Fuse{namespace Input{uDelegateType* KeyReleasedHandler_typeof();}}}
namespace g{namespace Fuse{namespace Input{uType* Pointer__PELHolder_typeof();}}}
namespace g{namespace Fuse{namespace Input{uEnumType* Pointer__PELStatus_typeof();}}}
...
namespace g{namespace Fuse{namespace Input{uDelegateType* PointerEnteredHandler_typeof();}}}
...
namespace g{namespace Fuse{namespace Input{uDelegateType* PointerLeftHandler_typeof();}}}
...
namespace g{namespace Fuse{namespace Input{uDelegateType* PointerMovedHandler_typeof();}}}
...
namespace g{namespace Fuse{namespace Input{uDelegateType* PointerPressedHandler_typeof();}}}
...
namespace g{namespace Fuse{namespace Input{uDelegateType* PointerReleasedHandler_typeof();}}}
...
namespace g{namespace Fuse{namespace Input{uDelegateType* PointerWheelMovedHandler_typeof();}}}
...
namespace g{namespace Fuse{namespace Input{uDelegateType* TextEnteredHandler_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{uType* Expression__Argument_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct ComputeExpression_type; ::g::Fuse::Reactive::ComputeExpression_type* BinaryOperator_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{uEnumType* BindingMode_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct CapsObject_type; CapsObject_type* CapsObject_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct ComputeExpression_type; ComputeExpression_type* ComputeExpression_typeof();}}}
...
namespace g{namespace Fuse{namespace Reactive{struct Expression_type; ::g::Fuse::Reactive::Expression_type* DataFunction_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct DataSubscription_type; DataSubscription_type* DataSubscription_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct Expression_type; ::g::Fuse::Reactive::Expression_type* DataToResource_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct ExpressionListener_type; ::g::Fuse::Reactive::ExpressionListener_type* DataToResource__DataToResourceSubscription_typeof();}}}
...
namespace g{namespace Fuse{namespace Reactive{struct CapsObject_type; ::g::Fuse::Reactive::CapsObject_type* DeviceCaps_typeof();}}}
...
namespace g{namespace Fuse{namespace Reactive{struct ExpressionListener_type; ExpressionListener_type* ExpressionListener_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct ExpressionSubscriber_type; ExpressionSubscriber_type* ExpressionSubscriber_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{uEnumType* ComputeExpression__Flags_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{uEnumType* ExpressionSubscriber__Flags_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{uInterfaceType* IContext_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{uInterfaceType* WindowListItem__IDataWatcher_typeof();}}}
...
namespace g{namespace Fuse{namespace Reactive{uEnumType* InstanceIdentity_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{uEnumType* InstanceReuse_typeof();}}}
...
namespace g{namespace Fuse{namespace Reactive{uInterfaceType* IObservable_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{uInterfaceType* IObservableArray_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{uInterfaceType* IObservableObject_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{uInterfaceType* IObserver_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{uInterfaceType* IPropertyObserver_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{uInterfaceType* IPropertySubscription_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct PlatformFunction_type; ::g::Fuse::Reactive::PlatformFunction_type* IsAndroidFunction_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct ComputeExpression_type; ::g::Fuse::Reactive::ComputeExpression_type* IsDefined_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct PlatformFunction_type; ::g::Fuse::Reactive::PlatformFunction_type* IsDesktopFunction_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct PlatformFunction_type; ::g::Fuse::Reactive::PlatformFunction_type* IsIOSFunction_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct PlatformFunction_type; ::g::Fuse::Reactive::PlatformFunction_type* IsMobileFunction_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct PlatformFunction_type; ::g::Fuse::Reactive::PlatformFunction_type* IsOSXFunction_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{uInterfaceType* ISubscription_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct PlatformFunction_type; ::g::Fuse::Reactive::PlatformFunction_type* IsWindowsFunction_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct ItemsWindowList_type; ItemsWindowList_type* ItemsWindowList_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{uInterfaceType* ValueForwarder__IValueListener_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{uInterfaceType* IWriteable_typeof();}}}
...
namespace g{namespace Fuse{namespace Reactive{struct ComputeExpression_type; ::g::Fuse::Reactive::ComputeExpression_type* NullCoalesce_typeof();}}}
...
namespace g{namespace Fuse{namespace Reactive{struct Expression_type; ::g::Fuse::Reactive::Expression_type* Parameter_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct PlatformFunction_type; PlatformFunction_type* PlatformFunction_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct Expression_type; ::g::Fuse::Reactive::Expression_type* Property_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct CapsObject__PropertySubscription_type; CapsObject__PropertySubscription_type* CapsObject__PropertySubscription_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct ComputeExpression_type; ::g::Fuse::Reactive::ComputeExpression_type* QuaternaryOperator_typeof();}}}
...
namespace g{namespace Fuse{namespace Reactive{struct CapsObject_type; ::g::Fuse::Reactive::CapsObject_type* WindowCaps_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct Expression_type; ::g::Fuse::Reactive::Expression_type* WindowFunction_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct ValueObserver_type; ::g::Fuse::Reactive::ValueObserver_type* WindowItem_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct WindowList_type; WindowList_type* WindowList_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct ValueObserver_type; ::g::Fuse::Reactive::ValueObserver_type* WindowListItem_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{namespace Internal{uStructType* SimpleAlgorithm__Location_typeof();}}}}
namespace g{namespace Fuse{namespace Reactive{namespace Internal{uEnumType* PatchAlgorithm_typeof();}}}}
...
namespace g{namespace Fuse{namespace Reactive{namespace Internal{uEnumType* PatchOp_typeof();}}}}
namespace g{namespace Fuse{namespace Reactive{namespace Internal{uType* SimpleAlgorithm_typeof();}}}}
namespace g{namespace Fuse{namespace Reactive{namespace FuseJS{uType* Http__HttpJSDispatcher__ActionClosure_typeof();}}}}
...
namespace g{namespace Fuse{namespace Reactive{namespace FuseJS{struct Http__HttpJSDispatcher_type; Http__HttpJSDispatcher_type* Http__HttpJSDispatcher_typeof();}}}}
...
namespace g{namespace Fuse{namespace Reactive{struct Expression_type;}} namespace Fuse{namespace Motion{::g::Fuse::Reactive::Expression_type* DelayFunction_typeof();}}}
...
namespace g{namespace Fuse{namespace Motion{uEnumType* MotionDestinationType_typeof();}}}
namespace g{namespace Fuse{namespace Motion{uEnumType* MotionUnit_typeof();}}}
namespace g{namespace Fuse{namespace Motion{uType* NavigationMotion_typeof();}}}
namespace g{namespace Fuse{namespace Motion{uEnumType* OverflowType_typeof();}}}
...
namespace g{namespace Fuse{namespace Motion{namespace Simulation{uInterfaceType* BoundedRegion2D_typeof();}}}}
namespace g{namespace Fuse{namespace Motion{namespace Simulation{uInterfaceType* DestinationSimulation_typeof();}}}}
...
namespace g{namespace Fuse{namespace Motion{namespace Simulation{uInterfaceType* MotionSimulation_typeof();}}}}
namespace g{namespace Fuse{namespace Motion{namespace Simulation{uEnumType* BasicBoundedRegion2D__MoveMode_typeof();}}}}
namespace g{namespace Fuse{namespace Motion{namespace Simulation{uType* PointerVelocity_typeof();}}}}
namespace g{namespace Fuse{namespace Motion{namespace Simulation{uEnumType* SampleFlags_typeof();}}}}
namespace g{namespace Fuse{namespace Motion{namespace Simulation{uInterfaceType* Simulation_typeof();}}}}
...
namespace g{namespace Fuse{namespace Drawing{uEnumType* FillRule_typeof();}}}
...
namespace g{namespace Fuse{namespace Drawing{uInterfaceType* IDrawObjectWatcherFeedback_typeof();}}}
namespace g{namespace Fuse{namespace Drawing{struct ImageFill_type; ImageFill_type* ImageFill_typeof();}}}
namespace g{namespace Fuse{namespace Drawing{uInterfaceType* INativeSurfaceOwner_typeof();}}}
namespace g{namespace Fuse{namespace Drawing{uInterfaceType* ISolidColor_typeof();}}}
namespace g{namespace Fuse{namespace Drawing{uInterfaceType* ISurfaceDrawable_typeof();}}}
namespace g{namespace Fuse{namespace Drawing{uInterfaceType* ISurfaceProvider_typeof();}}}
...
namespace g{namespace Fuse{namespace Drawing{uEnumType* LinearGradientInterpolation_typeof();}}}
namespace g{namespace Fuse{namespace Drawing{uEnumType* LineCap_typeof();}}}
namespace g{namespace Fuse{namespace Drawing{uEnumType* LineJoin_typeof();}}}
...
namespace g{namespace Fuse{namespace Drawing{uEnumType* LineSegmentFlags_typeof();}}}
namespace g{namespace Fuse{namespace Drawing{uType* LineSegments_typeof();}}}
namespace g{namespace Fuse{namespace Drawing{uEnumType* LineSegmentType_typeof();}}}
namespace g{namespace Fuse{namespace Drawing{uType* LineSplitter_typeof();}}}
namespace g{namespace Fuse{namespace Drawing{uStructType* LineSplitter__LSInfo_typeof();}}}
...
namespace g{namespace Fuse{namespace Drawing{uEnumType* ResampleMode_typeof();}}}
namespace g{namespace Fuse{namespace Drawing{uStructType* LineSplitter__SegmentAt_typeof();}}}
...
namespace g{namespace Fuse{namespace Drawing{uEnumType* StrokeAdjustment_typeof();}}}
namespace g{namespace Fuse{namespace Drawing{uEnumType* StrokeAlignment_typeof();}}}
...
namespace g{namespace Fuse{namespace Drawing{uEnumType* WrapMode_typeof();}}}
...
namespace g{namespace Fuse{namespace Triggers{uEnumType* BusyOn_typeof();}}}
namespace g{namespace Fuse{namespace Triggers{uType* BusyTask_typeof();}}}
namespace g{namespace Fuse{namespace Triggers{uEnumType* BusyTaskActivity_typeof();}}}
namespace g{namespace Fuse{namespace Triggers{uEnumType* BusyTaskMatch_typeof();}}}
...
namespace g{namespace Fuse{namespace Triggers{uEnumType* CompletedActivation_typeof();}}}
...
namespace g{namespace Fuse{namespace Triggers{uInterfaceType* IBusyHandler_typeof();}}}
namespace g{namespace Fuse{namespace Triggers{uInterfaceType* IMediaPlayback_typeof();}}}
namespace g{namespace Fuse{namespace Triggers{uInterfaceType* IPlayback_typeof();}}}
namespace g{namespace Fuse{namespace Triggers{uInterfaceType* IProgress_typeof();}}}
namespace g{namespace Fuse{namespace Triggers{uInterfaceType* IPulseTrigger_typeof();}}}
namespace g{namespace Fuse{namespace Triggers{uInterfaceType* IScrolledLength_typeof();}}}
namespace g{namespace Fuse{namespace Triggers{uClassType* IScrolledLengths_typeof();}}}
namespace g{namespace Fuse{namespace Triggers{uInterfaceType* IValue_typeof();}}}
...
namespace g{namespace Fuse{namespace Triggers{uDelegateType* LayoutTransitionedHandler_typeof();}}}
...
namespace g{namespace Fuse{namespace Triggers{uDelegateType* PulseTrigger__PulseHandler_typeof();}}}
namespace g{namespace Fuse{namespace Triggers{struct Trigger_type; ::g::Fuse::Triggers::Trigger_type* PulseTrigger_typeof();}}}
namespace g{namespace Fuse{namespace Triggers{uEnumType* WhileFloat__Range_typeof();}}}
...
namespace g{namespace Fuse{namespace Triggers{uEnumType* ScrolledWhere_typeof();}}}
...
namespace g{namespace Fuse{namespace Triggers{uEnumType* TransitionMode_typeof();}}}
namespace g{namespace Fuse{namespace Triggers{struct Trigger_type; Trigger_type* Trigger_typeof();}}}
namespace g{namespace Fuse{namespace Triggers{uEnumType* TriggerBypassMode_typeof();}}}
namespace g{namespace Fuse{namespace Triggers{uEnumType* TriggerPlayState_typeof();}}}
...
namespace g{namespace Fuse{namespace Triggers{uEnumType* WhileStringTest_typeof();}}}
...
namespace g{namespace Fuse{namespace Triggers{namespace Actions{uInterfaceType* ICollapse_typeof();}}}}
namespace g{namespace Fuse{namespace Triggers{namespace Actions{uInterfaceType* IHide_typeof();}}}}
namespace g{namespace Fuse{namespace Triggers{namespace Actions{uInterfaceType* IShow_typeof();}}}}
namespace g{namespace Fuse{namespace Triggers{namespace Actions{uInterfaceType* ITaggedDebugProperty_typeof();}}}}
namespace g{namespace Fuse{namespace Triggers{namespace Actions{uInterfaceType* IToggleable_typeof();}}}}
...
namespace g{namespace Fuse{namespace Triggers{namespace Actions{uDelegateType* JSEventHandler_typeof();}}}}
...
namespace g{namespace Fuse{namespace Triggers{namespace Actions{uEnumType* TimelineActionHow_typeof();}}}}
...
namespace g{namespace Fuse{namespace Triggers{namespace Actions{uEnumType* TransitionStateType_typeof();}}}}
...
namespace g{namespace Fuse{namespace Triggers{namespace Actions{uEnumType* TriggerWhen_typeof();}}}}
...
namespace g{namespace Fuse{namespace Elements{uEnumType* Alignment_typeof();}}}
...
namespace g{namespace Fuse{namespace Elements{uEnumType* AspectConstraint_typeof();}}}
...
namespace g{namespace Fuse{namespace Elements{uEnumType* CachingMode_typeof();}}}
...
namespace g{namespace Fuse{namespace Elements{uEnumType* BoxSizing__ConstraintFlags_typeof();}}}
...
namespace g{namespace Fuse{namespace Elements{uEnumType* HitTestMode_typeof();}}}
namespace g{namespace Fuse{namespace Elements{uInterfaceType* IElementBatchDrawable_typeof();}}}
namespace g{namespace Fuse{struct Transform_type; namespace Elements{::g::Fuse::Transform_type* InteractiveTransform_typeof();}}}
namespace g{namespace Fuse{namespace Elements{uInterfaceType* ITransformOrigin_typeof();}}}
namespace g{namespace Fuse{namespace Elements{uInterfaceType* ITreeRenderer_typeof();}}}
...
namespace g{namespace Fuse{namespace Elements{uEnumType* LayoutMasterMode_typeof();}}}
...
namespace g{namespace Fuse{namespace Elements{uEnumType* OptionalSimpleAlignment_typeof();}}}
...
namespace g{namespace Fuse{namespace Elements{uDelegateType* PreplacementHandler_typeof();}}}
...
namespace g{namespace Fuse{namespace Elements{uEnumType* SimpleAlignment_typeof();}}}
...
namespace g{namespace Fuse{namespace Elements{uEnumType* StretchDirection_typeof();}}}
namespace g{namespace Fuse{namespace Elements{uEnumType* StretchMode_typeof();}}}
namespace g{namespace Fuse{namespace Elements{uEnumType* StretchSizing_typeof();}}}
namespace g{namespace Fuse{namespace Reactive{struct InnerListener_type;}} namespace Fuse{namespace Elements{::g::Fuse::Reactive::InnerListener_type* LayoutFunction__Subscription_typeof();}}}
...
namespace g{namespace Fuse{namespace Elements{uEnumType* Visibility_typeof();}}}
...
namespace g{namespace Fuse{namespace Effects{uEnumType* EffectType_typeof();}}}
...
namespace g{namespace Fuse{namespace Effects{uEnumType* Mask__MaskMode_typeof();}}}
...
namespace g{namespace Fuse{namespace Gestures{uDelegateType* ClickedHandler_typeof();}}}
namespace g{namespace Fuse{namespace Gestures{struct Clicker_type; Clicker_type* Clicker_typeof();}}}
namespace g{namespace Fuse{namespace Gestures{uDelegateType* ClickerEventHandler_typeof();}}}
namespace g{namespace Fuse{namespace Gestures{uEnumType* ClickerPointerIndex_typeof();}}}
...
namespace g{namespace Fuse{namespace Gestures{uEnumType* ScrollToHow_typeof();}}}
...
namespace g{namespace Fuse{namespace Gestures{uEnumType* SwipedHow_typeof();}}}
namespace g{namespace Fuse{namespace Gestures{uEnumType* SwipeDirection_typeof();}}}
...
namespace g{namespace Fuse{namespace Gestures{uEnumType* SwipeType_typeof();}}}
...
namespace g{namespace Fuse{namespace Gestures{uDelegateType* TappedHandler_typeof();}}}
...
namespace g{namespace Fuse{namespace Gestures{namespace Internal{uEnumType* SwipeRegion__ProgressFlags_typeof();}}}}
...
namespace g{namespace Fuse{namespace Navigation{uDelegateType* Router__HistoryAction_typeof();}}}
namespace g{namespace Fuse{namespace Navigation{uDelegateType* HistoryChangedHandler_typeof();}}}
namespace g{namespace Fuse{namespace Navigation{uInterfaceType* IBaseNavigation_typeof();}}}
namespace g{namespace Fuse{namespace Navigation{uInterfaceType* INavigation_typeof();}}}
...
namespace g{namespace Fuse{namespace Navigation{uInterfaceType* IPagePropertyListener_typeof();}}}
...
namespace g{namespace Fuse{namespace Navigation{uEnumType* NavigationEdge_typeof();}}}
namespace g{namespace Fuse{namespace Navigation{uEnumType* NavigationGotoMode_typeof();}}}
namespace g{namespace Fuse{namespace Navigation{uDelegateType* NavigationHandler_typeof();}}}
namespace g{namespace Fuse{namespace Navigation{uEnumType* NavigationMode_typeof();}}}
namespace g{namespace Fuse{namespace Navigation{uDelegateType* NavigationPageCountHandler_typeof();}}}
...
namespace g{namespace Fuse{namespace Navigation{uType* RouterRequest_typeof();}}}
namespace g{namespace Fuse{namespace Navigation{uEnumType* RoutingOperation_typeof();}}}
namespace g{namespace Fuse{namespace Navigation{uEnumType* RoutingResult_typeof();}}}
...
namespace g{namespace Fuse{namespace Layouts{uEnumType* ColumnLayoutSizing_typeof();}}}
namespace g{namespace Fuse{namespace Layouts{uEnumType* DefinitionBase__CreationType_typeof();}}}
...
namespace g{namespace Fuse{namespace Layouts{uEnumType* Dock_typeof();}}}
namespace g{namespace Fuse{namespace Layouts{struct Layout_type; ::g::Fuse::Layouts::Layout_type* DockLayout_typeof();}}}
namespace g{namespace Fuse{namespace Layouts{uEnumType* FlowDirection_typeof();}}}
namespace g{namespace Fuse{namespace Layouts{uEnumType* GridChildOrder_typeof();}}}
...
namespace g{namespace Fuse{namespace Layouts{uEnumType* Metric_typeof();}}}
namespace g{namespace Fuse{namespace Layouts{uEnumType* Orientation_typeof();}}}
...
namespace g{namespace Fuse{namespace Layouts{uEnumType* StackLayoutMode_typeof();}}}
namespace g{namespace Fuse{namespace Layouts{struct Layout_type; ::g::Fuse::Layouts::Layout_type* WrapLayout_typeof();}}}
namespace g{namespace Fuse{namespace Android{uEnumType* StaticLayout__Alignment_typeof();}}}
...
namespace g{namespace Fuse{namespace Android{uEnumType* TextUtils__TruncateAt_typeof();}}}
...
namespace g{namespace Fuse{namespace WebSocket{uInterfaceType* IWebSocketClient_typeof();}}}
...
void uInitRtti()
{
    ...
    {
        (uType*(*)())&::g::FuseCommon_bundle_typeof,
        ...
        (uType*(*)())&::g::FuseControlsNavigation_FuseElementsElement_HitTestMode_Property_typeof,
        (uType*(*)())&::g::FuseControlsPanels_FuseElementsElement_Padding_Property_typeof,
        ...
        (uType*(*)())&::g::App_LoginSignup_bundle_typeof,
        (uType*(*)())&::g::App_LoginSignup_FuseControlsTextControl_Value_Property_typeof,
        (uType*(*)())&::g::App_LoginSignup_FuseControlsTextInputControl_Value_Property_typeof,
        (uType*(*)())&::g::App_LoginSignup_FuseControlsWebView_Url_Property_typeof,
        (uType*(*)())&::g::App_LoginSignup_FuseDrawingImageFill_Url_Property_typeof,
        (uType*(*)())&::g::App_LoginSignup_FuseElementsElement_Opacity_Property_typeof,
        (uType*(*)())&::g::App_LoginSignup_FuseTriggersActionsDebugAction_Message_Property_typeof,
        (uType*(*)())&::g::App_LoginSignup_FuseTriggersWhileBool_Value_Property_typeof,
        (uType*(*)())&::g::FacebookLogin_typeof,
        ...
        (uType*(*)())&::g::result_typeof,
        (uType*(*)())&::g::SignUp_typeof,
        ...
        (uType*(*)())&::g::OpenGL::GLBufferTarget_typeof,
        (uType*(*)())&::g::OpenGL::GLBufferUsage_typeof,
        (uType*(*)())&::g::OpenGL::GLClearBufferMask_typeof,
        (uType*(*)())&::g::OpenGL::GLCullFaceMode_typeof,
        (uType*(*)())&::g::OpenGL::GLDataType_typeof,
        (uType*(*)())&::g::OpenGL::GLDepthFunction_typeof,
        (uType*(*)())&::g::OpenGL::GLEnableCap_typeof,
        (uType*(*)())&::g::OpenGL::GLError_typeof,
        (uType*(*)())&::g::OpenGL::GLFramebufferAttachment_typeof,
        (uType*(*)())&::g::OpenGL::GLFramebufferHandle_typeof,
        (uType*(*)())&::g::OpenGL::GLFramebufferStatus_typeof,
        (uType*(*)())&::g::OpenGL::GLFramebufferTarget_typeof,
        (uType*(*)())&::g::OpenGL::GLFrontFaceDirection_typeof,
        (uType*(*)())&::g::OpenGL::GLIndexType_typeof,
        (uType*(*)())&::g::OpenGL::GLInteger4Name_typeof,
        (uType*(*)())&::g::OpenGL::GLIntegerName_typeof,
        (uType*(*)())&::g::OpenGL::GLPixelFormat_typeof,
        (uType*(*)())&::g::OpenGL::GLPixelType_typeof,
        (uType*(*)())&::g::OpenGL::GLPrimitiveType_typeof,
        (uType*(*)())&::g::OpenGL::GLProgramHandle_typeof,
        (uType*(*)())&::g::OpenGL::GLProgramParameter_typeof,
        (uType*(*)())&::g::OpenGL::GLRenderbufferHandle_typeof,
        (uType*(*)())&::g::OpenGL::GLRenderbufferStorage_typeof,
        (uType*(*)())&::g::OpenGL::GLRenderbufferTarget_typeof,
        (uType*(*)())&::g::OpenGL::GLShaderHandle_typeof,
        (uType*(*)())&::g::OpenGL::GLShaderParameter_typeof,
        (uType*(*)())&::g::OpenGL::GLShaderType_typeof,
        (uType*(*)())&::g::OpenGL::GLStringName_typeof,
        (uType*(*)())&::g::OpenGL::GLTextureHandle_typeof,
        (uType*(*)())&::g::OpenGL::GLTextureParameterName_typeof,
        (uType*(*)())&::g::OpenGL::GLTextureParameterValue_typeof,
        (uType*(*)())&::g::OpenGL::GLTextureTarget_typeof,
        (uType*(*)())&::g::OpenGL::GLTextureUnit_typeof,
        (uType*(*)())&::g::Uno::Action_typeof,
        (uType*(*)())&::g::Uno::Action1_typeof,
        (uType*(*)())&::g::Uno::Action2_typeof,
        (uType*(*)())&::g::Uno::Action3_typeof,
        (uType*(*)())&::g::Uno::Action4_typeof,
        ...
        (uType*(*)())&::g::Uno::DateTimeKind_typeof,
        (uType*(*)())&::g::Uno::Delegate_typeof,
        (uType*(*)())&::g::Uno::Double_typeof,
        (uType*(*)())&::g::Uno::Enum_typeof,
        (uType*(*)())&::g::Uno::Environment_typeof,
        (uType*(*)())&::g::Uno::EventArgs_typeof,
        (uType*(*)())&::g::Uno::EventHandler_typeof,
        (uType*(*)())&::g::Uno::EventHandler1_typeof,
        ...
        (uType*(*)())&::g::Uno::Func_typeof,
        (uType*(*)())&::g::Uno::Func1_typeof,
        (uType*(*)())&::g::Uno::Func2_typeof,
        (uType*(*)())&::g::Uno::Func3_typeof,
        (uType*(*)())&::g::Uno::GC_typeof,
        (uType*(*)())&::g::Uno::Generic_typeof,
        (uType*(*)())&::g::Uno::Guid_typeof,
        (uType*(*)())&::g::Uno::IDisposable_typeof,
        ...
        (uType*(*)())&::g::Uno::TypeInitializationException_typeof,
        ...
        (uType*(*)())&::g::Uno::Collections::Dictionary__BucketState_typeof,
        ...
        (uType*(*)())&::g::Uno::Collections::IEnumerable_typeof,
        (uType*(*)())&::g::Uno::Collections::IEnumerator_typeof,
        (uType*(*)())&::g::Uno::Collections::IEnumerator1_typeof,
        (uType*(*)())&::g::Uno::Collections::IList_typeof,
        ...
        (uType*(*)())&::g::Uno::Collections::PriorityQueueType_typeof,
        ...
        (uType*(*)())&::g::Uno::Diagnostics::AssertionHandler_typeof,
        (uType*(*)())&::g::Uno::Diagnostics::Clock_typeof,
        (uType*(*)())&::g::Uno::Diagnostics::Debug_typeof,
        (uType*(*)())&::g::Uno::Diagnostics::DebugMessageType_typeof,
        (uType*(*)())&::g::Uno::Diagnostics::LogHandler_typeof,
        (uType*(*)())&::g::Uno::Graphics::BlendEquation_typeof,
        (uType*(*)())&::g::Uno::Graphics::BlendOperand_typeof,
        (uType*(*)())&::g::Uno::Graphics::BufferUsage_typeof,
        (uType*(*)())&::g::Uno::Graphics::CompareFunc_typeof,
        (uType*(*)())&::g::Uno::Graphics::DeviceBuffer_typeof,
        (uType*(*)())&::g::Uno::Graphics::Format_typeof,
        (uType*(*)())&::g::Uno::Graphics::FormatHelpers_typeof,
        (uType*(*)())&::g::Uno::Graphics::Framebuffer_typeof,
        (uType*(*)())&::g::Uno::Graphics::FramebufferFlags_typeof,
        (uType*(*)())&::g::Uno::Graphics::IndexBuffer_typeof,
        (uType*(*)())&::g::Uno::Graphics::IndexType_typeof,
        (uType*(*)())&::g::Uno::Graphics::PolygonFace_typeof,
        (uType*(*)())&::g::Uno::Graphics::PolygonWinding_typeof,
        (uType*(*)())&::g::Uno::Graphics::PrimitiveType_typeof,
        (uType*(*)())&::g::Uno::Graphics::RenderTarget_typeof,
        (uType*(*)())&::g::Uno::Graphics::SamplerState_typeof,
        (uType*(*)())&::g::Uno::Graphics::Texture2D_typeof,
        (uType*(*)())&::g::Uno::Graphics::TextureAddressMode_typeof,
        (uType*(*)())&::g::Uno::Graphics::TextureFilter_typeof,
        ...
        (uType*(*)())&::g::Uno::IO::UserDirectory_typeof,
        (uType*(*)())&::g::Uno::Platform::AndroidDisplay_typeof,
        (uType*(*)())&::g::Uno::Platform::ApplicationState_typeof,
        (uType*(*)())&::g::Uno::Platform::ApplicationStateTransitionHandler_typeof,
        (uType*(*)())&::g::Uno::Platform::CoreApp_typeof,
        (uType*(*)())&::g::Uno::Platform::Display_typeof,
        (uType*(*)())&::g::Uno::Platform::Displays_typeof,
        (uType*(*)())&::g::Uno::Platform::EventModifiers_typeof,
        (uType*(*)())&::g::Uno::Platform::Key_typeof,
        (uType*(*)())&::g::Uno::Platform::KeyEventArgs_typeof,
        (uType*(*)())&::g::Uno::Platform::OSFrame_typeof,
        (uType*(*)())&::g::Uno::Platform::PointerType_typeof,
        ...
        (uType*(*)())&::g::Uno::Runtime::Implementation::Internal::FormatStringTokenizer__State_typeof,
        ...
        (uType*(*)())&::g::Uno::Threading::EventResetMode_typeof,
        (uType*(*)())&::g::Uno::Threading::EventWaitHandle_typeof,
        (uType*(*)())&::g::Uno::Threading::Future_typeof,
        (uType*(*)())&::g::Uno::Threading::Future1_typeof,
        (uType*(*)())&::g::Uno::Threading::FutureState_typeof,
        (uType*(*)())&::g::Uno::Threading::IDispatcher_typeof,
        (uType*(*)())&::g::Uno::Threading::ITaskScheduler_typeof,
        ...
        (uType*(*)())&::g::Uno::Threading::TaskDelegate_typeof,
        ...
        (uType*(*)())&::g::Uno::Time::Text::IPatternPart_typeof,
        ...
        (uType*(*)())&::g::Uno::UX::Expression_typeof,
        (uType*(*)())&::g::Uno::UX::FileSource_typeof,
        (uType*(*)())&::g::Uno::UX::IPropertyListener_typeof,
        ...
        (uType*(*)())&::g::Uno::Net::Sockets::SocketFlags_typeof,
        ...
        (uType*(*)())&::g::Uno::Net::Http::HttpRequestState_typeof,
        (uType*(*)())&::g::Uno::Net::Http::HttpResponseType_typeof,
        ...
        (uType*(*)())&::g::Android::Base::JNI__RefType_typeof,
        ...
        (uType*(*)())&::g::Android::Base::Wrappers::IJWrapper_typeof,
        ...
        (uType*(*)())&::g::Fuse::BoolComputer_typeof,
        (uType*(*)())&::g::Fuse::Box_typeof,
        (uType*(*)())&::g::Fuse::CacheFramebuffer_typeof,
        (uType*(*)())&::g::Fuse::Visual__CancelInteractionsType_typeof,
        (uType*(*)())&::g::Fuse::Collision_typeof,
        (uType*(*)())&::g::Fuse::Computer_typeof,
        (uType*(*)())&::g::Fuse::Computer1_typeof,
        (uType*(*)())&::g::Fuse::NodeGroupBase__ConstructFlags_typeof,
        (uType*(*)())&::g::Fuse::Node__ContextDataResult_typeof,
        (uType*(*)())&::g::Fuse::Node__DataType_typeof,
        (uType*(*)())&::g::Fuse::Node__DataWatcher_typeof,
        (uType*(*)())&::g::Fuse::DeferredManager_typeof,
        (uType*(*)())&::g::Fuse::Diagnostic_typeof,
        (uType*(*)())&::g::Fuse::DiagnosticHandler_typeof,
        (uType*(*)())&::g::Fuse::Diagnostics_typeof,
        (uType*(*)())&::g::Fuse::DiagnosticType_typeof,
        ...
        (uType*(*)())&::g::Fuse::LayoutParams__Flags_typeof,
        ...
        (uType*(*)())&::g::Fuse::HitTestCallback_typeof,
        (uType*(*)())&::g::Fuse::HitTestContext_typeof,
        (uType*(*)())&::g::Fuse::Visual__HitTestRecord_typeof,
        (uType*(*)())&::g::Fuse::HitTestResult_typeof,
        (uType*(*)())&::g::Fuse::Visual__HitTestTransformMode_typeof,
        (uType*(*)())&::g::Fuse::IActualPlacement_typeof,
        (uType*(*)())&::g::Fuse::IArray_typeof,
        (uType*(*)())&::g::Fuse::IBeginRemoveVisualListener_typeof,
        (uType*(*)())&::g::Fuse::ICommonViewport_typeof,
        (uType*(*)())&::g::Fuse::Marshal__IConverter_typeof,
        (uType*(*)())&::g::Fuse::Node__IDataListener_typeof,
        (uType*(*)())&::g::Fuse::IDeferred_typeof,
        (uType*(*)())&::g::Fuse::ScalingModes__IdentityMode_typeof,
        (uType*(*)())&::g::Fuse::IFrame_typeof,
        (uType*(*)())&::g::Fuse::IFrustum_typeof,
        (uType*(*)())&::g::Fuse::ILoading_typeof,
        (uType*(*)())&::g::Fuse::ILoadingStatic_typeof,
        (uType*(*)())&::g::Fuse::INameListener_typeof,
        (uType*(*)())&::g::Fuse::INotifyUnrooted_typeof,
        (uType*(*)())&::g::Fuse::Visual__InteractionItem_typeof,
        (uType*(*)())&::g::Fuse::InvalidateLayoutReason_typeof,
        (uType*(*)())&::g::Fuse::IObject_typeof,
        (uType*(*)())&::g::Fuse::IParentObserver_typeof,
        (uType*(*)())&::g::Fuse::IPreviewStateSaver_typeof,
        (uType*(*)())&::g::Fuse::IProperties_typeof,
        ...
        (uType*(*)())&::g::Fuse::ITransformRelative_typeof,
        (uType*(*)())&::g::Fuse::ITranslationMode_typeof,
        (uType*(*)())&::g::Fuse::IUpdateListener_typeof,
        (uType*(*)())&::g::Fuse::IViewport_typeof,
        (uType*(*)())&::g::Fuse::JSFileSource_typeof,
        (uType*(*)())&::g::Fuse::Json_typeof,
        (uType*(*)())&::g::Fuse::KeyboardBootstrapper_typeof,
        (uType*(*)())&::g::Fuse::Layer_typeof,
        (uType*(*)())&::g::Fuse::LayoutDependent_typeof,
        (uType*(*)())&::g::Fuse::LayoutParams_typeof,
        (uType*(*)())&::g::Fuse::LayoutPriority_typeof,
        (uType*(*)())&::g::Fuse::LayoutRole_typeof,
        (uType*(*)())&::g::Fuse::TranslationModes__LocalMode_typeof,
        (uType*(*)())&::g::Fuse::LostMarginBoxArgs_typeof,
        (uType*(*)())&::g::Fuse::LostMarginBoxHandler_typeof,
        ...
        (uType*(*)())&::g::Fuse::Node__NodeDataSubscription_typeof,
        ...
        (uType*(*)())&::g::Fuse::PlacedHandler_typeof,
        ...
        (uType*(*)())&::g::Fuse::RequestBringIntoViewHandler_typeof,
        (uType*(*)())&::g::Fuse::RootStage_typeof,
        ...
        (uType*(*)())&::g::Fuse::SystemFont__Style_typeof,
        ...
        (uType*(*)())&::g::Fuse::VisualBounds__Type_typeof,
        (uType*(*)())&::g::Fuse::UnhandledExceptionArgs_typeof,
        (uType*(*)())&::g::Fuse::UnhandledExceptionHandler_typeof,
        ...
        (uType*(*)())&::g::Fuse::Animations::ContinuousTrackProvider_typeof,
        ...
        (uType*(*)())&::g::Fuse::Animations::CycleRestore_typeof,
        (uType*(*)())&::g::Fuse::Animations::CycleState_typeof,
        (uType*(*)())&::g::Fuse::Animations::CycleWaveform_typeof,
        ...
        (uType*(*)())&::g::Fuse::Animations::DiscreteTrackProvider_typeof,
        ...
        (uType*(*)())&::g::Fuse::Animations::IBasePlayerFeedback_typeof,
        (uType*(*)())&::g::Fuse::Animations::IMixer_typeof,
        (uType*(*)())&::g::Fuse::Animations::IMixerHandle_typeof,
        (uType*(*)())&::g::Fuse::Animations::IMixerMaster_typeof,
        (uType*(*)())&::g::Fuse::Animations::IPlayerFeedback_typeof,
        (uType*(*)())&::g::Fuse::Animations::IResize_typeof,
        (uType*(*)())&::g::Fuse::Animations::IResizeMode_typeof,
        (uType*(*)())&::g::Fuse::Animations::IUnwrappedPlayerFeedback_typeof,
        ...
        (uType*(*)())&::g::Fuse::Animations::MasterPropertyGet_typeof,
        ...
        (uType*(*)())&::g::Fuse::Animations::MixOp_typeof,
        ...
        (uType*(*)())&::g::Fuse::Animations::PlayerFeedbackFlags_typeof,
        (uType*(*)())&::g::Fuse::Animations::PlayerPart_typeof,
        (uType*(*)())&::g::Fuse::Animations::PlayMode_typeof,
        ...
        (uType*(*)())&::g::Fuse::Animations::SeekDirection_typeof,
        (uType*(*)())&::g::Fuse::Animations::TriggerAnimationState__SeekFlags_typeof,
        (uType*(*)())&::g::Fuse::Animations::SeekResult_typeof,
        ...
        (uType*(*)())&::g::Fuse::Animations::TrackProvider_typeof,
        ...
        (uType*(*)())&::g::Fuse::Animations::DestinationBehavior__ValueHandler_typeof,
        ...
        (uType*(*)())&::g::Fuse::Internal::ObjectList__Equality_typeof,
        ...
        (uType*(*)())&::g::Fuse::Internal::IImageContainerOwner_typeof,
        (uType*(*)())&::g::Fuse::Internal::ImageContainer_typeof,
        (uType*(*)())&::g::Fuse::Internal::MiniList_typeof,
        (uType*(*)())&::g::Fuse::Internal::MiniListMode_typeof,
        ...
        (uType*(*)())&::g::Fuse::Resources::LoadingImageSource__CleanupReason_typeof,
        (uType*(*)())&::g::Fuse::Resources::DisposalManager_typeof,
        (uType*(*)())&::g::Fuse::Resources::DisposalRequest_typeof,
        ...
        (uType*(*)())&::g::Fuse::Resources::ImageSourceErrorHandler_typeof,
        (uType*(*)())&::g::Fuse::Resources::ImageSourceState_typeof,
        (uType*(*)())&::g::Fuse::Resources::IMemoryResource_typeof,
        (uType*(*)())&::g::Fuse::Resources::ISoftDisposable_typeof,
        ...
        (uType*(*)())&::g::Fuse::Resources::Exif::ImageOrientation_typeof,
        (uType*(*)())&::g::Fuse::Scripting::NativeEventEmitterModule__ActionClosure_typeof,
        ...
        (uType*(*)())&::g::Fuse::Scripting::ScriptMethod1__ArgumentMirrorClosure_typeof,
        ...
        (uType*(*)())&::g::Fuse::Scripting::ExecutionThread_typeof,
        ...
        (uType*(*)())&::g::Fuse::Scripting::FutureFactory_typeof,
        (uType*(*)())&::g::Fuse::Scripting::ScriptPromise__FutureFactory_typeof,
        (uType*(*)())&::g::Fuse::Scripting::IEventSerializer_typeof,
        (uType*(*)())&::g::Fuse::Scripting::IFunctionMirror_typeof,
        (uType*(*)())&::g::Fuse::Scripting::IModuleProvider_typeof,
        (uType*(*)())&::g::Fuse::Scripting::IRaw_typeof,
        (uType*(*)())&::g::Fuse::Scripting::IScriptEvent_typeof,
        (uType*(*)())&::g::Fuse::Scripting::IScriptObject_typeof,
        (uType*(*)())&::g::Fuse::Scripting::IThreadWorker_typeof,
        ...
        (uType*(*)())&::g::Fuse::Scripting::NativeCallback_typeof,
        ...
        (uType*(*)())&::g::Fuse::Scripting::SubscriptionSubject__Subscription_typeof,
        (uType*(*)())&::g::Fuse::Scripting::SubscriptionSubject_typeof,
        (uType*(*)())&::g::Fuse::Scripting::Value_typeof,
        (uType*(*)())&::g::Fuse::Scripting::ValueConverter_typeof,
        (uType*(*)())&::g::Fuse::Scripting::ValueMirror_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::Observable__Add_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::TreeObservable__AddOperation_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::ArrayMirror_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::TreeArray__ArraySubscription_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::ClassInstance_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::Observable__Clear_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::Observable__Subscription__ClearExclusiveOperation_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::ThreadWorker__ContextIgnoringAction_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::DateTimeConverterHelpers_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::ThreadWorker__ExceptionClosure_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::Observable__Failed_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::IMirror_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::Observable__InsertAll_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::Observable__InsertAt_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::TreeObservable__InsertAtOperation_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::JSContext_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::TreeObject__PropertySubscription__JSThreadSet_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::LazyObservableProperty_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::JSContext__MethodClosure_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::ModuleInstance_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::Observable__NewAll_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::Observable__NewAt_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::ObjectMirror_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::Observable_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::ObservableProperty_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::Observable__Operation_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::TreeObservable__Operation_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::TreeObservable__Operation__PerformClosure_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::JSContext__PropertyClosure_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::TreeObject__PropertySubscription_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::ObservableProperty__PushCapture_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::JSContext__ReadonlyPropertyClosure_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::Observable__RemoveAt_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::TreeObservable__RemoveAtOperation_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::Observable__RemoveRange_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::Observable__Subscription__ReplaceAllExclusiveOperation_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::TreeArray__ArraySubscription__ReplaceAllOperation_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::ObservableProperty__ResolveDefaultValueClosure_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::RootableScriptModule_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::ScriptModuleNames_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::Observable__Set_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::TreeObject__SetClosure_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::Observable__Subscription__SetExclusiveOperation_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::TreeObservable__SetOperation_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::TreeArray__ArraySubscription__SimpleArray_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::Observable__Subscription_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::ThreadWorker_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::TreeArray_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::TreeObject_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::TreeObservable_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::TypeWrapper_typeof,
        (uType*(*)())&::g::Fuse::Scripting::JavaScript::TreeObservable__ValueOperation_typeof,
        ...
        (uType*(*)())&::g::Fuse::Scripting::V8::V8SimpleExtensions__WrappedCallback_typeof,
        (uType*(*)())&::g::Fuse::Scripting::V8::Simple::Context_typeof,
        (uType*(*)())&::g::Fuse::Scripting::V8::Simple::JSArray_typeof,
        (uType*(*)())&::g::Fuse::Scripting::V8::Simple::JSCallback_typeof,
        ...
        (uType*(*)())&::g::Fuse::Controls::CommonNavigationPages__AddedPage_typeof,
        ...
        (uType*(*)())&::g::Fuse::Controls::CommonNavigation_typeof,
        (uType*(*)())&::g::Fuse::Controls::CommonNavigationPages_typeof,
        ...
        (uType*(*)())&::g::Fuse::Controls::CurveClose_typeof,
        (uType*(*)())&::g::Fuse::Controls::CurveExtrude_typeof,
        (uType*(*)())&::g::Fuse::Controls::CurvePoint_typeof,
        (uType*(*)())&::g::Fuse::Controls::CurveStyle_typeof,
        ...
        (uType*(*)())&::g::Fuse::Controls::FitMode_typeof,
        (uType*(*)())&::g::Fuse::Controls::GraphicsView_typeof,
        (uType*(*)())&::g::Fuse::Controls::Grid_typeof,
        (uType*(*)())&::g::Fuse::Controls::CurvePoint__HasFlags_typeof,
        (uType*(*)())&::g::Fuse::Controls::Image_typeof,
        (uType*(*)())&::g::Fuse::Controls::ImageElementDraw_typeof,
        (uType*(*)())&::g::Fuse::Controls::INativeViewRoot_typeof,
        (uType*(*)())&::g::Fuse::Controls::NativeViewHost__InitialState_typeof,
        ...
        (uType*(*)())&::g::Fuse::Controls::NavigationControlBlockInput_typeof,
        (uType*(*)())&::g::Fuse::Controls::NavigationControlInactiveState_typeof,
        (uType*(*)())&::g::Fuse::Controls::NavigationControlInteraction_typeof,
        (uType*(*)())&::g::Fuse::Controls::NavigationControlTransition_typeof,
        (uType*(*)())&::g::Fuse::Controls::NavigationSwitchedHandler_typeof,
        (uType*(*)())&::g::Fuse::Controls::Navigator_typeof,
        (uType*(*)())&::g::Fuse::Controls::NavigatorGotoState_typeof,
        (uType*(*)())&::g::Fuse::Controls::NavigatorSwipe_typeof,
        (uType*(*)())&::g::Fuse::Controls::NavigatorSwipeDirection_typeof,
        (uType*(*)())&::g::Fuse::Controls::NavigatorSwipeHow_typeof,
        ...
        (uType*(*)())&::g::Fuse::Controls::CommonNavigationPages__PagesMap_typeof,
        (uType*(*)())&::g::Fuse::Controls::Panel_typeof,
        (uType*(*)())&::g::Fuse::Controls::Path_typeof,
        (uType*(*)())&::g::Fuse::Controls::PathExpression_typeof,
        (uType*(*)())&::g::Fuse::Controls::PathMeasureMode_typeof,
        (uType*(*)())&::g::Fuse::Controls::PathPointAtDistance_typeof,
        (uType*(*)())&::g::Fuse::Controls::PathPointAtTime_typeof,
        (uType*(*)())&::g::Fuse::Controls::PathExpression__PathSubscription_typeof,
        (uType*(*)())&::g::Fuse::Controls::PathTangentAngleAtDistance_typeof,
        ...
        (uType*(*)())&::g::Fuse::Controls::TextInputActionType_typeof,
        ...
        (uType*(*)())&::g::Fuse::Controls::NavigationControl__UpdateFlags_typeof,
        ...
        (uType*(*)())&::g::Fuse::Controls::Native::IGraphicsView_typeof,
        (uType*(*)())&::g::Fuse::Controls::Native::IImageView_typeof,
        (uType*(*)())&::g::Fuse::Controls::Native::ILabelView_typeof,
        ...
        (uType*(*)())&::g::Fuse::Controls::Native::IShapeView_typeof,
        (uType*(*)())&::g::Fuse::Controls::Native::ITextEdit_typeof,
        (uType*(*)())&::g::Fuse::Controls::Native::ITextEditHost_typeof,
        (uType*(*)())&::g::Fuse::Controls::Native::ITextView_typeof,
        (uType*(*)())&::g::Fuse::Controls::Native::IToggleView_typeof,
        (uType*(*)())&::g::Fuse::Controls::Native::IToggleViewHost_typeof,
        (uType*(*)())&::g::Fuse::Controls::Native::IView_typeof,
        (uType*(*)())&::g::Fuse::Controls::Native::IViewHandleRenderer_typeof,
        (uType*(*)())&::g::Fuse::Controls::Native::IViewHost_typeof,
        ...
        (uType*(*)())&::g::Fuse::Controls::NavigationInternal::BlockInputWhileNavigating_typeof,
        ...
        (uType*(*)())&::g::Fuse::Controls::VideoImpl::IVideoCallbacks_typeof,
        (uType*(*)())&::g::Fuse::Controls::VideoImpl::IVideoPlayer_typeof,
        (uType*(*)())&::g::Fuse::Controls::VideoImpl::IVideoService_typeof,
        (uType*(*)())&::g::Fuse::Controls::VideoImpl::LoadingClosure_typeof,
        (uType*(*)())&::g::Fuse::Controls::VideoImpl::VideoVisual__PlaybackTarget_typeof,
        ...
        (uType*(*)())&::g::Fuse::Input::CaptureType_typeof,
        ...
        (uType*(*)())&::g::Fuse::Input::PointerReleasedHandler_typeof,
        (uType*(*)())&::g::Fuse::Input::PointerWheelMoved_typeof,
        (uType*(*)())&::g::Fuse::Input::PointerWheelMovedArgs_typeof,
        (uType*(*)())&::g::Fuse::Input::PointerWheelMovedHandler_typeof,
        ...
        (uType*(*)())&::g::Fuse::Input::TextEnteredHandler_typeof,
        (uType*(*)())&::g::Fuse::Reactive::Expression__Argument_typeof,
        (uType*(*)())&::g::Fuse::Reactive::BinaryOperator_typeof,
        (uType*(*)())&::g::Fuse::Reactive::BindingMode_typeof,
        (uType*(*)())&::g::Fuse::Reactive::CapsObject_typeof,
        (uType*(*)())&::g::Fuse::Reactive::ComputeExpression_typeof,
        ...
        (uType*(*)())&::g::Fuse::Reactive::DataFunction_typeof,
        ...
        (uType*(*)())&::g::Fuse::Reactive::DeviceCaps_typeof,
        ...
        (uType*(*)())&::g::Fuse::Reactive::ExpressionListener_typeof,
        (uType*(*)())&::g::Fuse::Reactive::ExpressionSubscriber_typeof,
        (uType*(*)())&::g::Fuse::Reactive::ComputeExpression__Flags_typeof,
        (uType*(*)())&::g::Fuse::Reactive::ExpressionSubscriber__Flags_typeof,
        (uType*(*)())&::g::Fuse::Reactive::IContext_typeof,
        (uType*(*)())&::g::Fuse::Reactive::WindowListItem__IDataWatcher_typeof,
        ...
        (uType*(*)())&::g::Fuse::Reactive::InstanceIdentity_typeof,
        (uType*(*)())&::g::Fuse::Reactive::InstanceReuse_typeof,
        ...
        (uType*(*)())&::g::Fuse::Reactive::IObservable_typeof,
        (uType*(*)())&::g::Fuse::Reactive::IObservableArray_typeof,
        (uType*(*)())&::g::Fuse::Reactive::IObservableObject_typeof,
        (uType*(*)())&::g::Fuse::Reactive::IObserver_typeof,
        (uType*(*)())&::g::Fuse::Reactive::IPropertyObserver_typeof,
        (uType*(*)())&::g::Fuse::Reactive::IPropertySubscription_typeof,
        (uType*(*)())&::g::Fuse::Reactive::IsAndroidFunction_typeof,
        (uType*(*)())&::g::Fuse::Reactive::IsDefined_typeof,
        (uType*(*)())&::g::Fuse::Reactive::IsDesktopFunction_typeof,
        (uType*(*)())&::g::Fuse::Reactive::IsIOSFunction_typeof,
        (uType*(*)())&::g::Fuse::Reactive::IsMobileFunction_typeof,
        (uType*(*)())&::g::Fuse::Reactive::IsOSXFunction_typeof,
        (uType*(*)())&::g::Fuse::Reactive::ISubscription_typeof,
        (uType*(*)())&::g::Fuse::Reactive::IsWindowsFunction_typeof,
        (uType*(*)())&::g::Fuse::Reactive::ItemsWindowList_typeof,
        (uType*(*)())&::g::Fuse::Reactive::ValueForwarder__IValueListener_typeof,
        (uType*(*)())&::g::Fuse::Reactive::IWriteable_typeof,
        ...
        (uType*(*)())&::g::Fuse::Reactive::PlatformFunction_typeof,
        (uType*(*)())&::g::Fuse::Reactive::Property_typeof,
        (uType*(*)())&::g::Fuse::Reactive::CapsObject__PropertySubscription_typeof,
        ...
        (uType*(*)())&::g::Fuse::Reactive::WindowCaps_typeof,
        (uType*(*)())&::g::Fuse::Reactive::WindowFunction_typeof,
        (uType*(*)())&::g::Fuse::Reactive::WindowItem_typeof,
        (uType*(*)())&::g::Fuse::Reactive::WindowList_typeof,
        (uType*(*)())&::g::Fuse::Reactive::WindowListItem_typeof,
        (uType*(*)())&::g::Fuse::Reactive::Internal::SimpleAlgorithm__Location_typeof,
        (uType*(*)())&::g::Fuse::Reactive::Internal::PatchAlgorithm_typeof,
        (uType*(*)())&::g::Fuse::Reactive::Internal::PatchItem_typeof,
        (uType*(*)())&::g::Fuse::Reactive::Internal::PatchList_typeof,
        (uType*(*)())&::g::Fuse::Reactive::Internal::PatchOp_typeof,
        (uType*(*)())&::g::Fuse::Reactive::Internal::SimpleAlgorithm_typeof,
        (uType*(*)())&::g::Fuse::Reactive::FuseJS::Http__HttpJSDispatcher__ActionClosure_typeof,
        ...
        (uType*(*)())&::g::Fuse::Reactive::FuseJS::Http__HttpJSDispatcher_typeof,
        ...
        (uType*(*)())&::g::Fuse::Motion::MotionDestinationType_typeof,
        (uType*(*)())&::g::Fuse::Motion::MotionUnit_typeof,
        (uType*(*)())&::g::Fuse::Motion::NavigationMotion_typeof,
        (uType*(*)())&::g::Fuse::Motion::OverflowType_typeof,
        ...
        (uType*(*)())&::g::Fuse::Motion::Simulation::BoundedRegion2D_typeof,
        (uType*(*)())&::g::Fuse::Motion::Simulation::DestinationSimulation_typeof,
        ...
        (uType*(*)())&::g::Fuse::Motion::Simulation::MotionSimulation_typeof,
        (uType*(*)())&::g::Fuse::Motion::Simulation::BasicBoundedRegion2D__MoveMode_typeof,
        (uType*(*)())&::g::Fuse::Motion::Simulation::PointerVelocity_typeof,
        (uType*(*)())&::g::Fuse::Motion::Simulation::SampleFlags_typeof,
        (uType*(*)())&::g::Fuse::Motion::Simulation::Simulation_typeof,
        ...
        (uType*(*)())&::g::Fuse::Drawing::FillRule_typeof,
        (uType*(*)())&::g::Fuse::Drawing::GradientStop_typeof,
        (uType*(*)())&::g::Fuse::Drawing::GraphicsSurface_typeof,
        (uType*(*)())&::g::Fuse::Drawing::IDrawObjectWatcherFeedback_typeof,
        (uType*(*)())&::g::Fuse::Drawing::ImageFill_typeof,
        (uType*(*)())&::g::Fuse::Drawing::INativeSurfaceOwner_typeof,
        (uType*(*)())&::g::Fuse::Drawing::ISolidColor_typeof,
        (uType*(*)())&::g::Fuse::Drawing::ISurfaceDrawable_typeof,
        (uType*(*)())&::g::Fuse::Drawing::ISurfaceProvider_typeof,
        ...
        (uType*(*)())&::g::Fuse::Drawing::LinearGradientInterpolation_typeof,
        (uType*(*)())&::g::Fuse::Drawing::LineCap_typeof,
        (uType*(*)())&::g::Fuse::Drawing::LineJoin_typeof,
        ...
        (uType*(*)())&::g::Fuse::Drawing::LineSegmentFlags_typeof,
        (uType*(*)())&::g::Fuse::Drawing::LineSegments_typeof,
        (uType*(*)())&::g::Fuse::Drawing::LineSegmentType_typeof,
        (uType*(*)())&::g::Fuse::Drawing::LineSplitter_typeof,
        (uType*(*)())&::g::Fuse::Drawing::LineSplitter__LSInfo_typeof,
        (uType*(*)())&::g::Fuse::Drawing::NativeSurface_typeof,
        (uType*(*)())&::g::Fuse::Drawing::RepeatBaker_typeof,
        (uType*(*)())&::g::Fuse::Drawing::ResampleMode_typeof,
        (uType*(*)())&::g::Fuse::Drawing::LineSplitter__SegmentAt_typeof,
        ...
        (uType*(*)())&::g::Fuse::Drawing::StrokeAdjustment_typeof,
        (uType*(*)())&::g::Fuse::Drawing::StrokeAlignment_typeof,
        ...
        (uType*(*)())&::g::Fuse::Drawing::WrapMode_typeof,
        ...
        (uType*(*)())&::g::Fuse::Triggers::BusyOn_typeof,
        (uType*(*)())&::g::Fuse::Triggers::BusyTask_typeof,
        (uType*(*)())&::g::Fuse::Triggers::BusyTaskActivity_typeof,
        (uType*(*)())&::g::Fuse::Triggers::BusyTaskMatch_typeof,
        (uType*(*)())&::g::Fuse::Triggers::BusyTaskModule_typeof,
        (uType*(*)())&::g::Fuse::Triggers::Completed_typeof,
        (uType*(*)())&::g::Fuse::Triggers::CompletedActivation_typeof,
        ...
        (uType*(*)())&::g::Fuse::Triggers::IBusyHandler_typeof,
        (uType*(*)())&::g::Fuse::Triggers::IMediaPlayback_typeof,
        (uType*(*)())&::g::Fuse::Triggers::IPlayback_typeof,
        (uType*(*)())&::g::Fuse::Triggers::IProgress_typeof,
        (uType*(*)())&::g::Fuse::Triggers::IPulseTrigger_typeof,
        (uType*(*)())&::g::Fuse::Triggers::IScrolledLength_typeof,
        (uType*(*)())&::g::Fuse::Triggers::IScrolledLengths_typeof,
        (uType*(*)())&::g::Fuse::Triggers::IValue_typeof,
        ...
        (uType*(*)())&::g::Fuse::Triggers::LayoutTransitionedHandler_typeof,
        ...
        (uType*(*)())&::g::Fuse::Triggers::PulseTrigger__PulseHandler_typeof,
        (uType*(*)())&::g::Fuse::Triggers::PulseTrigger_typeof,
        (uType*(*)())&::g::Fuse::Triggers::WhileFloat__Range_typeof,
        ...
        (uType*(*)())&::g::Fuse::Triggers::ScrolledWhere_typeof,
        ...
        (uType*(*)())&::g::Fuse::Triggers::TransitionMode_typeof,
        (uType*(*)())&::g::Fuse::Triggers::Trigger_typeof,
        (uType*(*)())&::g::Fuse::Triggers::TriggerBypassMode_typeof,
        (uType*(*)())&::g::Fuse::Triggers::TriggerPlayState_typeof,
        ...
        (uType*(*)())&::g::Fuse::Triggers::WhileStringTest_typeof,
        ...
        (uType*(*)())&::g::Fuse::Triggers::Actions::ICollapse_typeof,
        (uType*(*)())&::g::Fuse::Triggers::Actions::IHide_typeof,
        (uType*(*)())&::g::Fuse::Triggers::Actions::IShow_typeof,
        (uType*(*)())&::g::Fuse::Triggers::Actions::ITaggedDebugProperty_typeof,
        (uType*(*)())&::g::Fuse::Triggers::Actions::IToggleable_typeof,
        (uType*(*)())&::g::Fuse::Triggers::Actions::JSEventArgs_typeof,
        (uType*(*)())&::g::Fuse::Triggers::Actions::JSEventHandler_typeof,
        ...
        (uType*(*)())&::g::Fuse::Triggers::Actions::TimelineActionHow_typeof,
        ...
        (uType*(*)())&::g::Fuse::Elements::CachingMode_typeof,
        (uType*(*)())&::g::Fuse::Elements::TransformOrigins__CenterOrigin_typeof,
        (uType*(*)())&::g::Fuse::Elements::BoxSizing__ConstraintFlags_typeof,
        ...
        (uType*(*)())&::g::Fuse::Elements::HitTestMode_typeof,
        (uType*(*)())&::g::Fuse::Elements::IElementBatchDrawable_typeof,
        (uType*(*)())&::g::Fuse::Elements::InteractiveTransform_typeof,
        (uType*(*)())&::g::Fuse::Elements::ITransformOrigin_typeof,
        (uType*(*)())&::g::Fuse::Elements::ITreeRenderer_typeof,
        ...
        (uType*(*)())&::g::Fuse::Elements::StretchDirection_typeof,
        (uType*(*)())&::g::Fuse::Elements::StretchMode_typeof,
        (uType*(*)())&::g::Fuse::Elements::StretchSizing_typeof,
        (uType*(*)())&::g::Fuse::Elements::LayoutFunction__Subscription_typeof,
        ...
        (uType*(*)())&::g::Fuse::Elements::Visibility_typeof,
        ...
        (uType*(*)())&::g::Fuse::Effects::EffectType_typeof,
        (uType*(*)())&::g::Fuse::Effects::Halftone_typeof,
        (uType*(*)())&::g::Fuse::Effects::Mask_typeof,
        (uType*(*)())&::g::Fuse::Effects::Mask__MaskMode_typeof,
        (uType*(*)())&::g::Fuse::Gestures::Clicked_typeof,
        (uType*(*)())&::g::Fuse::Gestures::ClickedArgs_typeof,
        (uType*(*)())&::g::Fuse::Gestures::ClickedHandler_typeof,
        (uType*(*)())&::g::Fuse::Gestures::Clicker_typeof,
        (uType*(*)())&::g::Fuse::Gestures::ClickerEventHandler_typeof,
        (uType*(*)())&::g::Fuse::Gestures::ClickerPointerIndex_typeof,
        ...
        (uType*(*)())&::g::Fuse::Gestures::Internal::SwipeRegion__ProgressFlags_typeof,
        ...
        (uType*(*)())&::g::Fuse::Navigation::Router__HistoryAction_typeof,
        (uType*(*)())&::g::Fuse::Navigation::HistoryChangedHandler_typeof,
        (uType*(*)())&::g::Fuse::Navigation::IBaseNavigation_typeof,
        (uType*(*)())&::g::Fuse::Navigation::INavigation_typeof,
        (uType*(*)())&::g::Fuse::Navigation::RouteModificationCommand__InnerSubscription_typeof,
        (uType*(*)())&::g::Fuse::Navigation::IPagePropertyListener_typeof,
        ...
        (uType*(*)())&::g::Fuse::Navigation::NavigatedHandler_typeof,
        ...
        (uType*(*)())&::g::Fuse::Navigation::NavigationEdge_typeof,
        (uType*(*)())&::g::Fuse::Navigation::NavigationGotoMode_typeof,
        (uType*(*)())&::g::Fuse::Navigation::NavigationHandler_typeof,
        (uType*(*)())&::g::Fuse::Navigation::NavigationMode_typeof,
        (uType*(*)())&::g::Fuse::Navigation::NavigationPageCountHandler_typeof,
        ...
        (uType*(*)())&::g::Fuse::Navigation::RoutingOperation_typeof,
        (uType*(*)())&::g::Fuse::Navigation::RoutingResult_typeof,
        ...
        (uType*(*)())&::g::Fuse::Layouts::ColumnLayoutSizing_typeof,
        (uType*(*)())&::g::Fuse::Layouts::DefinitionBase__CreationType_typeof,
        (uType*(*)())&::g::Fuse::Layouts::DefaultLayout_typeof,
        (uType*(*)())&::g::Fuse::Layouts::DefinitionBase_typeof,
        (uType*(*)())&::g::Fuse::Layouts::Dock_typeof,
        (uType*(*)())&::g::Fuse::Layouts::DockLayout_typeof,
        (uType*(*)())&::g::Fuse::Layouts::FlowDirection_typeof,
        (uType*(*)())&::g::Fuse::Layouts::GridChildOrder_typeof,
        (uType*(*)())&::g::Fuse::Layouts::GridLayout_typeof,
        (uType*(*)())&::g::Fuse::Layouts::Layout_typeof,
        (uType*(*)())&::g::Fuse::Layouts::Layouts_typeof,
        (uType*(*)())&::g::Fuse::Layouts::Metric_typeof,
        (uType*(*)())&::g::Fuse::Layouts::Orientation_typeof,
        (uType*(*)())&::g::Fuse::Layouts::Row_typeof,
        (uType*(*)())&::g::Fuse::Layouts::StackLayout_typeof,
        (uType*(*)())&::g::Fuse::Layouts::StackLayoutMode_typeof,
        (uType*(*)())&::g::Fuse::Layouts::WrapLayout_typeof,
        (uType*(*)())&::g::Fuse::Android::StaticLayout__Alignment_typeof,
        ...
        (uType*(*)())&::g::Fuse::Android::TextUtils__TruncateAt_typeof,
        ...
        (uType*(*)())&::g::Fuse::WebSocket::IWebSocketClient_typeof,
