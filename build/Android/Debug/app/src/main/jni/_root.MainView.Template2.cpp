...
{
    MainView__Template2::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"result"*/]);
}

static void MainView__Template2_build(uType* type)
{
    ::STRINGS[0] = uString::Const("result");
...
{
    ::g::result* __self1 = ::g::result::New4(uPtr(__this->__parent1)->router);
