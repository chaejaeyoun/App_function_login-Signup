...
#include <Fuse.Elements.LayoutF-73173981.h>
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.10.0-rc1/Enums.uno
// ----------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.10.0-rc1/Element.Transform.uno
// ----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.10.0-rc1/AspectBoxSizing.uno
// --------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.10.0-rc1/BoxSizing.uno
// --------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.10.0-rc1/Caching/Cache.Heuristic.uno
// ----------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.10.0-rc1/Caching/Cache.uno
// ------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.10.0-rc1/Caching/ElementAtlasPool.uno
// -----------------------------------------------------------------------------------
...
void Element__Draw_fn(Element* __this, ::g::Fuse::DrawContext* dc)
{
    if (!__this->IsRootingCompleted())
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Draw called on a non-rooted node"), __this, uString::Const("/usr/local/share/uno/Packages/Fuse.Elements/1.10.0-rc1/Element.Drawing.uno"), 67, uString::Const("Draw"));
...
// protected override sealed Fuse.VisualBounds get_HitTestChildrenBounds() :109
...
void Element__OnArrangeMarginBox_fn(Element* __this, ::g::Uno::Float2* position, ::g::Fuse::LayoutParams* lp, ::g::Uno::Float2* __retval)
{
    ...
    if (bp.SanityConstrain())
    {
        if (!Element::_invalidValuesWarn_)
            ::g::Fuse::Diagnostics::InternalError(uString::Const("Invalid values in ArrangeMarginBox"), __this, uString::Const("/usr/local/share/uno/Packages/Fuse.Elements/1.10.0-rc1/Element.Layout.uno"), 262, uString::Const("OnArrangeMarginBox"));
...
::g::Uno::UX::Size2 Element::Anchor()
{
    ...
    return (::g::Fuse::Visual__Get_fn(this, ::g::Fuse::Visual_typeof()->MakeMethod(3/*Get<Uno.UX.Size2>*/, ::g::Uno::UX::Size2_typeof(), NULL), uCRef<int32_t>(4096), uCRef(::g::Uno::UX::Size2__Auto()), &ret16), ret16);
}
...
{
    float ret17;
    return (::g::Fuse::Visual__Get_fn(this, ::g::Fuse::Visual_typeof()->MakeMethod(3/*Get<float>*/, ::g::Uno::Float_typeof(), NULL), uCRef<int32_t>(65536), uCRef(1.0f), &ret17), ret17);
}
...
{
    int32_t ret18;
    return (::g::Fuse::Visual__Get_fn(this, ::g::Fuse::Visual_typeof()->MakeMethod(3/*Get<Fuse.Elements.AspectConstraint>*/, ::g::Fuse::Elements::AspectConstraint_typeof(), NULL), uCRef<int32_t>(131072), uCRef<int32_t>(3), &ret18), ret18);
}
...
{
    int32_t ret19;
    return (::g::Fuse::Visual__Get_fn(this, ::g::Fuse::Visual_typeof()->MakeMethod(3/*Get<Fuse.Elements.CachingMode>*/, ::g::Fuse::Elements::CachingMode_typeof(), NULL), uCRef<int32_t>(262144), uCRef<int32_t>(0), &ret19), ret19);
}
...
::g::Fuse::VisualBounds* Element::CalcRenderBoundsWithEffects()
{
    ...
    if (HasActiveEffects())
        ...
        {
            ::g::Fuse::Effects::Effect* e = (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Effects()), ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Effects::Effect_typeof(), NULL)), uCRef<int32_t>(i), &ret10), ret10);
...
::g::Uno::Graphics::Framebuffer* Element::CaptureRegion(::g::Fuse::DrawContext* dc, ::g::Uno::Rect region, ::g::Uno::Float2 padding)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log3(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(uString::Const("CaptureRegion bigger than maximum texture size, dropping rendering (size: "), uBox(::g::Uno::Int2_typeof(), fsz)), uString::Const(", max-size: ")), uBox<int32_t>(::g::Uno::Int_typeof(), ::g::Uno::Graphics::Texture2D::MaxSize())), 0, uString::Const("/usr/local/share/uno/Packages/Fuse.Elements/1.10.0-rc1/Element.Drawing.uno"), 40);
        return NULL;
    }
...
void Element::Composit(::g::Fuse::DrawContext* dc)
{
    ...
    if (!flat && !_warnOpacityFlat)
    {
        ...
        ::g::Fuse::Diagnostics::UserWarning(uString::Const("This element has a partial opacity and is not flat. This will not render correctly. Put the opacity on a flat child panel instead."), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Elements/1.10.0-rc1/Element.Effects.uno"), 117, uString::Const("Composit"));
    }
    ...
    if (!r && !_warnNoCacheDraw)
    {
        ...
        ::g::Fuse::Diagnostics::InternalError(uString::Const("This element can not be drawn."), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Elements/1.10.0-rc1/Element.Effects.uno"), 125, uString::Const("Composit"));
    }
}
...
{
    int32_t ret22;
    return (::g::Fuse::Visual__Get_fn(this, ::g::Fuse::Visual_typeof()->MakeMethod(3/*Get<Fuse.Elements.HitTestMode>*/, ::g::Fuse::Elements::HitTestMode_typeof(), NULL), uCRef<int32_t>(524288), uCRef<int32_t>(5), &ret22), ret22);
}
...
{
    ::g::Uno::UX::Size ret23;
    return (::g::Fuse::Visual__Get_fn(this, ::g::Fuse::Visual_typeof()->MakeMethod(3/*Get<Uno.UX.Size>*/, ::g::Uno::UX::Size_typeof(), NULL), uCRef<int32_t>(16777216), uCRef(::g::Uno::UX::Size__Auto()), &ret23), ret23);
}
...
{
    ::g::Uno::UX::Size ret24;
    return (::g::Fuse::Visual__Get_fn(this, ::g::Fuse::Visual_typeof()->MakeMethod(3/*Get<Uno.UX.Size>*/, ::g::Uno::UX::Size_typeof(), NULL), uCRef<int32_t>(8388608), uCRef(::g::Uno::UX::Size__Auto()), &ret24), ret24);
}
...
{
    ::g::Uno::Float4 ret25;
    return (::g::Fuse::Visual__Get_fn(this, ::g::Fuse::Visual_typeof()->MakeMethod(3/*Get<float4>*/, ::g::Uno::Float4_typeof(), NULL), uCRef<int32_t>(1024), uCRef(::g::Uno::Float4__New1(0.0f)), &ret25), ret25);
}
...
{
    ::g::Uno::UX::Size ret26;
    return (::g::Fuse::Visual__Get_fn(this, ::g::Fuse::Visual_typeof()->MakeMethod(3/*Get<Uno.UX.Size>*/, ::g::Uno::UX::Size_typeof(), NULL), uCRef<int32_t>(512), uCRef(::g::Uno::UX::Size__Auto()), &ret26), ret26);
}
...
{
    ::g::Uno::UX::Size ret27;
    return (::g::Fuse::Visual__Get_fn(this, ::g::Fuse::Visual_typeof()->MakeMethod(3/*Get<Uno.UX.Size>*/, ::g::Uno::UX::Size_typeof(), NULL), uCRef<int32_t>(256), uCRef(::g::Uno::UX::Size__Auto()), &ret27), ret27);
}
...
{
    ::g::Uno::UX::Size ret28;
    return (::g::Fuse::Visual__Get_fn(this, ::g::Fuse::Visual_typeof()->MakeMethod(3/*Get<Uno.UX.Size>*/, ::g::Uno::UX::Size_typeof(), NULL), uCRef<int32_t>(128), uCRef(::g::Uno::UX::Size__Auto()), &ret28), ret28);
}
...
{
    ::g::Uno::UX::Size ret29;
    return (::g::Fuse::Visual__Get_fn(this, ::g::Fuse::Visual_typeof()->MakeMethod(3/*Get<Uno.UX.Size>*/, ::g::Uno::UX::Size_typeof(), NULL), uCRef<int32_t>(64), uCRef(::g::Uno::UX::Size__Auto()), &ret29), ret29);
}
...
::g::Uno::UX::Size2 Element::Offset()
{
    ...
    return (::g::Fuse::Visual__Get_fn(this, ::g::Fuse::Visual_typeof()->MakeMethod(3/*Get<Uno.UX.Size2>*/, ::g::Uno::UX::Size2_typeof(), NULL), uCRef<int32_t>(8192), uCRef(::g::Uno::UX::Size2__Auto()), &ret30), ret30);
}
...
{
    float ret31;
    return (::g::Fuse::Visual__Get_fn(this, ::g::Fuse::Visual_typeof()->MakeMethod(3/*Get<float>*/, ::g::Uno::Float_typeof(), NULL), uCRef<int32_t>(4194304), uCRef(1.0f), &ret31), ret31);
}
...
{
    ::g::Uno::Float4 ret32;
    return (::g::Fuse::Visual__Get_fn(this, ::g::Fuse::Visual_typeof()->MakeMethod(3/*Get<float4>*/, ::g::Uno::Float4_typeof(), NULL), uCRef<int32_t>(2048), uCRef(::g::Uno::Float4__New1(0.0f)), &ret32), ret32);
}
...
{
    uObject* ret33;
    return (::g::Fuse::Visual__Get_fn(this, ::g::Fuse::Visual_typeof()->MakeMethod(3/*Get<Fuse.Elements.ITransformOrigin>*/, ::TYPES[31/*Fuse.Elements.ITransformOrigin*/], NULL), uCRef<int32_t>(2097152), Element::DefaultTransformOrigin_, &ret33), ret33);
}
...
{
    ::g::Uno::UX::Size ret34;
    return (::g::Fuse::Visual__Get_fn(this, ::g::Fuse::Visual_typeof()->MakeMethod(3/*Get<Uno.UX.Size>*/, ::g::Uno::UX::Size_typeof(), NULL), uCRef<int32_t>(16384), uCRef(::g::Uno::UX::Size__Auto()), &ret34), ret34);
}
...
{
    ::g::Uno::UX::Size ret35;
    return (::g::Fuse::Visual__Get_fn(this, ::g::Fuse::Visual_typeof()->MakeMethod(3/*Get<Uno.UX.Size>*/, ::g::Uno::UX::Size_typeof(), NULL), uCRef<int32_t>(32768), uCRef(::g::Uno::UX::Size__Auto()), &ret35), ret35);
}
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.10.0-rc1/Caching/ElementAtlas.uno
// -------------------------------------------------------------------------------
...
// private extern void DiscardPool() :196
...
// private extern void DiscardPool() [instance] :196
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.10.0-rc1/Caching/ElementBatch.uno
// -------------------------------------------------------------------------------
...
static void ElementBatch_build(uType* type)
{
    ...
    ::TYPES[12] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(3/*Select<Fuse.Elements.ElementBatchEntry, Fuse.Visual>*/, ::g::Fuse::Elements::ElementBatchEntry_typeof(), ::g::Fuse::Visual_typeof(), NULL);
...
void ElementBatch::ctor_(::g::Fuse::Elements::ElementBatcher* elementBatcher, ::g::Fuse::Elements::ElementAtlas* elementAtlas)
{
    ...
    _positionInfo.Buffer = ::g::Uno::Graphics::VertexBuffer::New8(1);
    ...
    _texCoordInfo.Buffer = ::g::Uno::Graphics::VertexBuffer::New8(0);
    init_DrawCalls();
}
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.10.0-rc1/Caching/ElementBatcher.uno
// ---------------------------------------------------------------------------------
...
static void ElementBatcher_build(uType* type)
{
    ...
    ::STRINGS[12] = uString::Const("/usr/local/share/uno/Packages/Fuse.Elements/1.10.0-rc1/Caching/ElementBatcher.uno");
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.10.0-rc1/Element.Layout.uno
// -------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.10.0-rc1/LayoutFunctions.uno
// --------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.10.0-rc1/Element.HitTest.uno
// --------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.10.0-rc1/InteractiveTransform.uno
// -------------------------------------------------------------------------------
...
{
    InteractiveTransform::_zoomFactorName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[13/*"ZoomFactor"*/]);
    InteractiveTransform::_rotationName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[14/*"Rotation"*/]);
    InteractiveTransform::_translationName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[15/*"Translation"*/]);
}
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.10.0-rc1/Element.ITreeRenderer.uno
// --------------------------------------------------------------------------------
...
// protected bool TryComputeAlternate(object value, object& result) :31
...
// protected bool TryComputeAlternate(object value, object& result) [instance] :31
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.10.0-rc1/LayoutMasterBoxSizing.uno
// --------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.10.0-rc1/LimitBoxSizing.uno
// -------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.10.0-rc1/Transforms.uno
// ---------------------------------------------------------------------
...
static void LayoutFunction__Subscription_build(uType* type)
{
    ...
    ::STRINGS[17] = uString::Const("/usr/local/share/uno/Packages/Fuse.Elements/1.10.0-rc1/LayoutFunctions.uno");
